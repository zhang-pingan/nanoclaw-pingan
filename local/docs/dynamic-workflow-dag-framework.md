...
Capacity Admin CAP1 Invocation repair选择并闭合了真实的immutable prepared lifecycle：历史Database Schema `4`及其`applied | denied | conflict | duplicate | failed`语义只作为provenance保留；current Database Schema `5`增加`prepared`并以CHECK/trigger限制为上述唯一CAP1组合，提供Schema 4到5的保数据原子upgrade。CAP2-CAP4没有Invocation transition，CAP4只finalise Command canonical result。该repair仅修复G5前置Contract/Schema，不实现Capacity Admin Gateway/Publisher/Watcher或任何G5 Runtime；在独立affected-chain regression完成前，G5保持`BLOCKED/NOT_READY`而不是`DONE/READY`。

Current Capacity machine root/logical artifact/logical delta分别为`sha256:12f9fdfe9739b767440b56b0e55fedb431b27c546326da90285e96e1fc2ea15c` / `sha256:8160dea544586e02b3429dcc1bb044a40a330cb69920c4d1d2231fbed28866c5` / `sha256:749bdfe16195a1762427aed9d98ff8e7d9c2633d22b6d8e3d31bf9aeaf9d589c`；protocol semantic artifact保持`sha256:0e06b38b98bfd2193dbad24297e75b1422fdcc8f11e297835c87d4baf03aea9b`，fixture corpus为9 positive / 31 negative / 14 fault。历史G0.10 root/logical artifact/delta `sha256:21d06c2d9d45a47f6ebc68c24b9d0acec29c8ae1726d5387bd38c460a7a0a7ec` / `sha256:5d9e79b5f9330a5111e6f61b8d04164c87839a60d55ea350c0aa87b8b1559e66` / `sha256:e8917c737b1eae0f62abfa2de2dec6dc71875122a763882a46aee34c5c84cae6`继续作为Schema 4 predecessor provenance，不是current authority。
...
Capacity repair current G3.1/G3.3/G3.5/G3.6/G3.7/G3.9 pack identities分别为`sha256:de020bca9ffb54ac8cf7e8fd9166d1a26eef5d2b7fa79427c4fe47755f22caa3` / `sha256:f14adf777d92cbaf00275e5ad77b04746c1c9a42848d29cad0786d33a54cf52c` / `sha256:d38bdd8578efa8d1e4e8b7c6c9e4384d3b764b0cee18fe7f1d951752fad63cac` / `sha256:03131d78800718ac1bd326f932e33ca677d9ac617ff00fc090fc7aaefedd85a9` / `sha256:8a67b2516d46da89524045297b261e32305d0803546089048b19d70384e23282` / `sha256:7c192a3a4dd10004c2a7bf6da2cf81a38d5745e145717796f86acfc2025fdf91`。Frozen G3.8A和G2 sealed trees不在Capacity semantic dependency chain中，必须保持byte-identical。
...
Capacity Contract/Schema repair重新级联G4 exact bindings。Current pack/profile/bootstrap implementation/implementation artifact为`sha256:d55623b512d154018c78adadeaa66ae092db61f8efb1a2caeb1ae5f218fe5539` / `sha256:b79c3fbc1fb612a28e975805ab55e65c7bdbeb2fc17df4dd6fbd583334a0e2a6` / `sha256:28a920856d26325ec14c976a9e1da668c1302e06fd3e2e05abb890dff830f018` / `sha256:74803b081571df002b900dc6ed23b9c7fc83f86bcb8f096a331cf2011805825e`；isolation v2保持`sha256:883f8f2d4040fd03ea5a49bd38826ce6c37d5556175219b66f335793087f9188`。该级联只反映Schema 5/G3 exact inputs和Store implementation identity，不增加Runtime行为。Capacity repair进入独立affected-chain regression前，G5重新保持`NOT_READY/BLOCKED`。
...
Capacity repair current ownership authority=`sha256:4e973c234ddd2c37079b32f33df7780da0b8cbdda3f5eba091d314c7947ef2a8`，affected tree=`sha256:c1e1ff5d27410c497cf614458b7bb273e3aedaa9af879d7dd75423674219ccb5`；transaction/command继续为`sha256:3d5474096d89fbd723e34e0d2f9d1dadd1b955b5fc36ff447d026257852cac79` / `sha256:43cc8ef247fcba4bac5e9fccdd654fd393928120755a6405bad232043f0c94ba`。Authority exact绑定current Capacity root、Schema 5 G1 root/schema/Manifest、G3.1/G3.3/G3.5/G3.6/G3.7/G3.9与G4 pack/profile/implementation。Authority payload原有pending status、`implementation_authorized=false`与next-required-gate仍保持generation provenance；project状态为`CAPACITY_CONTRACT_SCHEMA_REPAIR_EXIT_CANDIDATE_PENDING_INDEPENDENT_REGRESSION`，不授权G5 Runtime施工。
