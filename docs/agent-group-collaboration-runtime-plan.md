...
- CollaborationStore 启动时精确检查表列，并对 execution 的 `epoch INTEGER NOT NULL`、关键列约束、unique/index 和外键语义 fail closed；fresh schema 与 v1 到当前版本的 migration 均覆盖临时 SQLite 正例。
