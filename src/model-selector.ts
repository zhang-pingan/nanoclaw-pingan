...
const modelEnv = readEnvFile([
  'ICARUS_MODEL_LIGHT',
  'ICARUS_MODEL_DEFAULT',
  'ICARUS_MODEL_HEAVY',
  'ICARUS_MODEL_FORCE',
  'CREDENTIAL_PROXY_OPENAI_COMPAT',
  'ICARUS_MODEL_SELECTOR_URL',
  'ICARUS_MODEL_SELECTOR_MODEL',
...
const SELECTOR_API_BASE_URL =
  process.env.ICARUS_MODEL_SELECTOR_URL ||
  modelEnv.ICARUS_MODEL_SELECTOR_URL ||
  'http://101.42.48.209:8000/v1';
const SELECTOR_API_MODEL =
  process.env.ICARUS_MODEL_SELECTOR_MODEL ||
  modelEnv.ICARUS_MODEL_SELECTOR_MODEL ||
  'DeepSeek-R1-Distill-Llama-70B';
const SELECTOR_TIMEOUT_MS = Math.max(
  1000,
  Number.parseInt(
    process.env.ICARUS_MODEL_SELECTOR_TIMEOUT_MS ||
      modelEnv.ICARUS_MODEL_SELECTOR_TIMEOUT_MS ||
      '30000',
    10,
  ) || 30000,
);
