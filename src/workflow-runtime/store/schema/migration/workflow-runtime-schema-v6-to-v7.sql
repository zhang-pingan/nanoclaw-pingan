...
ALTER TABLE "workflow_values" RENAME TO "workflow_values_schema6";

ALTER TABLE "workflow_plan_generated_schemas" RENAME TO "workflow_plan_generated_schemas_schema6";
...
INSERT INTO "workflow_plan_generated_schemas" ("plan_id", "graph_run_id", "plan_hash", "schema_ref", "schema_hash", "generator", "parameter_hash", "binding_hash", "created_at_ms") SELECT "plan_id", "graph_run_id", "plan_hash", "schema_ref", "schema_hash", "generator", "parameter_hash", "binding_hash", "created_at_ms" FROM "workflow_plan_generated_schemas_schema6";

INSERT INTO "workflow_values" ("id", "storage_kind", "inline_canonical_json", "blob_hash", "immutable_external_locator", "expected_hash", "content_hash", "byte_length", "media_type", "schema_resource_id", "schema_resource_hash", "provenance_ref", "retention_class", "payload_state", "payload_pruned_at_ms", "created_at_ms", "row_version", "schema_authority_kind", "schema_plan_id", "schema_plan_hash", "generated_schema_ref", "generated_schema_hash", "generated_schema_generator", "generated_schema_parameter_hash") SELECT "id", "storage_kind", "inline_canonical_json", "blob_hash", "immutable_external_locator", "expected_hash", "content_hash", "byte_length", "media_type", "schema_resource_id", "schema_resource_hash", "provenance_ref", "retention_class", "payload_state", "payload_pruned_at_ms", "created_at_ms", "row_version", "schema_authority_kind", "schema_plan_id", "schema_plan_hash", "generated_schema_ref", "generated_schema_hash", "generated_schema_generator", "generated_schema_parameter_hash" FROM "workflow_values_schema6";

DROP TABLE "workflow_values_schema6";

DROP TABLE "workflow_plan_generated_schemas_schema6";
