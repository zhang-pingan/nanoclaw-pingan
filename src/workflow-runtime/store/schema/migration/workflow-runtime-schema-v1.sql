...
CREATE TABLE "workflow_registry_snapshots" (
  ...
  "core_build_hash" TEXT NOT NULL /* logical_type=hash */,
  "database_schema_hash" TEXT NOT NULL /* logical_type=hash */,
  "created_at_ms" INTEGER NOT NULL /* logical_type=integer */,
  ...
  CONSTRAINT "ck:workflow_registry_snapshots:core_build_hash:hash" CHECK (("core_build_hash" IS NULL OR (length("core_build_hash") = 71 AND substr("core_build_hash", 1, 7) = 'sha256:' AND substr("core_build_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=core_build_hash */,
  CONSTRAINT "ck:workflow_registry_snapshots:database_schema_hash:hash" CHECK (("database_schema_hash" IS NULL OR (length("database_schema_hash") = 71 AND substr("database_schema_hash", 1, 7) = 'sha256:' AND substr("database_schema_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=database_schema_hash */,
...
CREATE TABLE "workflow_feature_releases" (
  ...
  "status" TEXT NOT NULL /* logical_type=text */,
  "compatibility_snapshot_ref" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=core_compatibility_registry reference_domain=compatibility_snapshot immutable=1 */,
  "compatibility_snapshot_hash" TEXT NOT NULL /* logical_type=hash */,
  ...
  CONSTRAINT "ck:workflow_feature_releases:compatibility_snapshot_hash:hash" CHECK (("compatibility_snapshot_hash" IS NULL OR (length("compatibility_snapshot_hash") = 71 AND substr("compatibility_snapshot_hash", 1, 7) = 'sha256:' AND substr("compatibility_snapshot_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=compatibility_snapshot_hash */,
...
CREATE TABLE "workflow_graph_runs" (
  ...
  "compiler_toolchain_resource_id" TEXT NOT NULL /* logical_type=identifier */,
  "compiler_toolchain_resource_hash" TEXT NOT NULL /* logical_type=hash */,
  "core_release_ref" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=core_release_registry reference_domain=core_release immutable=1 */,
  "core_release_hash" TEXT NOT NULL /* logical_type=hash */,
  "core_build_hash" TEXT NOT NULL /* logical_type=hash */,
  "run_protocol_major" INTEGER NOT NULL /* logical_type=integer */,
  "executor_abi_major" INTEGER NOT NULL /* logical_type=integer */,
  "database_schema_version" INTEGER NOT NULL /* logical_type=integer */,
  "database_schema_hash" TEXT NOT NULL /* logical_type=hash */,
  ...
  CONSTRAINT "fk:graph_runs:compiler_toolchain" FOREIGN KEY ("compiler_toolchain_resource_id", "compiler_toolchain_resource_hash") REFERENCES "workflow_registry_resources" ("id", "content_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_graph_runs:compiler_toolchain_resource_hash:hash" CHECK (("compiler_toolchain_resource_hash" IS NULL OR (length("compiler_toolchain_resource_hash") = 71 AND substr("compiler_toolchain_resource_hash", 1, 7) = 'sha256:' AND substr("compiler_toolchain_resource_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=compiler_toolchain_resource_hash */,
  CONSTRAINT "ck:workflow_graph_runs:core_release_hash:hash" CHECK (("core_release_hash" IS NULL OR (length("core_release_hash") = 71 AND substr("core_release_hash", 1, 7) = 'sha256:' AND substr("core_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=core_release_hash */,
  CONSTRAINT "ck:workflow_graph_runs:core_build_hash:hash" CHECK (("core_build_hash" IS NULL OR (length("core_build_hash") = 71 AND substr("core_build_hash", 1, 7) = 'sha256:' AND substr("core_build_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=core_build_hash */,
  CONSTRAINT "ck:workflow_graph_runs:run_protocol_major:safe_integer" CHECK (("run_protocol_major" IS NULL OR "run_protocol_major" BETWEEN 1 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=run_protocol_major */,
  CONSTRAINT "ck:workflow_graph_runs:executor_abi_major:safe_integer" CHECK (("executor_abi_major" IS NULL OR "executor_abi_major" BETWEEN 1 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=executor_abi_major */,
  CONSTRAINT "ck:workflow_graph_runs:database_schema_version:safe_integer" CHECK (("database_schema_version" IS NULL OR "database_schema_version" BETWEEN 1 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=database_schema_version */,
  CONSTRAINT "ck:workflow_graph_runs:database_schema_hash:hash" CHECK (("database_schema_hash" IS NULL OR (length("database_schema_hash") = 71 AND substr("database_schema_hash", 1, 7) = 'sha256:' AND substr("database_schema_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=database_schema_hash */,
...
CREATE TABLE "workflow_graph_child_completion_consumptions" (
  ...
  CONSTRAINT "fk:child_consumptions:child_scope" FOREIGN KEY ("child_scope_id") REFERENCES "workflow_graph_scopes" ("id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:child_consumptions:child_cut" FOREIGN KEY ("child_completion_cut_id") REFERENCES "workflow_graph_completion_cuts" ("id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:child_consumptions:parent_scope" FOREIGN KEY ("parent_scope_id") REFERENCES "workflow_graph_scopes" ("id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:child_consumptions:owner_node" FOREIGN KEY ("parent_scope_id", "owner_node_id") REFERENCES "workflow_graph_nodes" ("scope_id", "id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:child_consumptions:map_slot" FOREIGN KEY ("map_slot_id") REFERENCES "workflow_graph_map_item_results" ("id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:child_consumptions:map_disposition" CHECK ((("disposition" IN ('map_slot_completed', 'map_slot_fenced') AND "map_slot_id" IS NOT NULL) OR ("disposition" IN ('owner_output_published', 'non_publish_parent_fenced', 'non_publish_owner_fenced') AND "map_slot_id" IS NULL))) /* check_kind=state_field_consistency logical_columns=disposition,map_slot_id */
);
...
CREATE TABLE "workflow_graph_effect_operation_claims" (
  ...
  CONSTRAINT "fk:effect_claims:claim" FOREIGN KEY ("claim_id") REFERENCES "workflow_domain_resource_claims" ("id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE "runtime_capacity_admin_commands" (
  ...
  "genesis_core_release_hash" TEXT /* logical_type=hash */,
  ...
  CONSTRAINT "ck:runtime_capacity_admin_commands:genesis_core_release_hash:hash" CHECK (("genesis_core_release_hash" IS NULL OR (length("genesis_core_release_hash") = 71 AND substr("genesis_core_release_hash", 1, 7) = 'sha256:' AND substr("genesis_core_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=genesis_core_release_hash */,
  ...
  CONSTRAINT "ck:capacity_commands:command_mapping" CHECK ((("command_type" = 'initialize_deployment_capacity' AND "expected_capacity_revision" IS NULL AND "expected_config_hash" IS NULL AND "genesis_core_release_hash" IS NOT NULL AND "reason_code" = 'initial_provisioning' AND "reason_text_value_id" IS NULL AND "reason_text_hash" IS NULL) OR ("command_type" = 'replace_deployment_capacity' AND "expected_capacity_revision" IS NOT NULL AND "expected_config_hash" IS NOT NULL AND "genesis_core_release_hash" IS NULL AND "reason_code" <> 'initial_provisioning' AND "reason_text_value_id" IS NOT NULL AND "reason_text_hash" IS NOT NULL))) /* check_kind=closed_target_mapping logical_columns=command_type,expected_capacity_revision,expected_config_hash,genesis_core_release_hash,reason_code,reason_text_value_id,reason_text_hash */,
...
CREATE TABLE "workflow_feature_release_activation_commands" (
  ...
  "request_schema_hash" TEXT NOT NULL /* logical_type=hash */,
  "domain_request_hash" TEXT NOT NULL /* logical_type=hash */,
  "verified_compatibility_input_value_id" TEXT /* logical_type=identifier */,
  "verified_compatibility_input_hash" TEXT /* logical_type=hash */,
  "verified_compatibility_input_schema_resource_id" TEXT /* logical_type=identifier */,
  "verified_compatibility_input_schema_hash" TEXT /* logical_type=hash */,
  "verified_compatibility_result_value_id" TEXT /* logical_type=identifier */,
  "verified_compatibility_result_hash" TEXT /* logical_type=hash */,
  "verified_compatibility_result_schema_resource_id" TEXT /* logical_type=identifier */,
  "verified_compatibility_result_schema_hash" TEXT /* logical_type=hash */,
  ...
  CONSTRAINT "fk:activation_commands:verified_compatibility_input" FOREIGN KEY ("verified_compatibility_input_value_id", "verified_compatibility_input_hash", "verified_compatibility_input_schema_resource_id", "verified_compatibility_input_schema_hash") REFERENCES "workflow_values" ("id", "content_hash", "schema_resource_id", "schema_resource_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:activation_commands:verified_compatibility_result" FOREIGN KEY ("verified_compatibility_result_value_id", "verified_compatibility_result_hash", "verified_compatibility_result_schema_resource_id", "verified_compatibility_result_schema_hash") REFERENCES "workflow_values" ("id", "content_hash", "schema_resource_id", "schema_resource_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_feature_release_activation_commands:verified_compatibility_input_hash:hash" CHECK (("verified_compatibility_input_hash" IS NULL OR (length("verified_compatibility_input_hash") = 71 AND substr("verified_compatibility_input_hash", 1, 7) = 'sha256:' AND substr("verified_compatibility_input_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_compatibility_input_hash */,
  CONSTRAINT "ck:workflow_feature_release_activation_commands:verified_compatibility_input_schema_hash:hash" CHECK (("verified_compatibility_input_schema_hash" IS NULL OR (length("verified_compatibility_input_schema_hash") = 71 AND substr("verified_compatibility_input_schema_hash", 1, 7) = 'sha256:' AND substr("verified_compatibility_input_schema_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_compatibility_input_schema_hash */,
  CONSTRAINT "ck:workflow_feature_release_activation_commands:verified_compatibility_result_hash:hash" CHECK (("verified_compatibility_result_hash" IS NULL OR (length("verified_compatibility_result_hash") = 71 AND substr("verified_compatibility_result_hash", 1, 7) = 'sha256:' AND substr("verified_compatibility_result_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_compatibility_result_hash */,
  CONSTRAINT "ck:workflow_feature_release_activation_commands:verified_compatibility_result_schema_hash:hash" CHECK (("verified_compatibility_result_schema_hash" IS NULL OR (length("verified_compatibility_result_schema_hash") = 71 AND substr("verified_compatibility_result_schema_hash", 1, 7) = 'sha256:' AND substr("verified_compatibility_result_schema_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_compatibility_result_schema_hash */,
  ...
  CONSTRAINT "ck:activation_commands:verified_compatibility_input" CHECK ((("verified_compatibility_input_value_id" IS NULL AND "verified_compatibility_input_hash" IS NULL AND "verified_compatibility_input_schema_resource_id" IS NULL AND "verified_compatibility_input_schema_hash" IS NULL) OR ("verified_compatibility_input_value_id" IS NOT NULL AND "verified_compatibility_input_hash" IS NOT NULL AND "verified_compatibility_input_schema_resource_id" IS NOT NULL AND "verified_compatibility_input_schema_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=verified_compatibility_input_value_id,verified_compatibility_input_hash,verified_compatibility_input_schema_resource_id,verified_compatibility_input_schema_hash */,
  CONSTRAINT "ck:activation_commands:verified_compatibility_result" CHECK ((("verified_compatibility_result_value_id" IS NULL AND "verified_compatibility_result_hash" IS NULL AND "verified_compatibility_result_schema_resource_id" IS NULL AND "verified_compatibility_result_schema_hash" IS NULL) OR ("verified_compatibility_result_value_id" IS NOT NULL AND "verified_compatibility_result_hash" IS NOT NULL AND "verified_compatibility_result_schema_resource_id" IS NOT NULL AND "verified_compatibility_result_schema_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=verified_compatibility_result_value_id,verified_compatibility_result_hash,verified_compatibility_result_schema_resource_id,verified_compatibility_result_schema_hash */,
  ...
  CONSTRAINT "ck:activation_commands:verified_prefix" CHECK ((("verified_compatibility_input_value_id" IS NULL) = ("verified_compatibility_result_value_id" IS NULL)) AND ("verified_previous_feature_release_id" IS NULL OR "verified_target_feature_release_id" IS NOT NULL) AND ("verified_target_retention_handle_id" IS NULL OR ("verified_target_feature_release_id" IS NOT NULL AND "verified_compatibility_result_value_id" IS NOT NULL AND "verified_target_retention_feature_release_id" = "verified_target_feature_release_id")) AND ("verified_target_retention_observed_status" IS NULL OR "verified_target_retention_handle_id" IS NOT NULL) AND ("verified_previous_retention_handle_id" IS NULL OR ("verified_previous_feature_release_id" IS NOT NULL AND "verified_target_retention_observed_status" = 'held' AND "verified_previous_retention_feature_release_id" = "verified_previous_feature_release_id")) AND ("verified_previous_retention_observed_status" IS NULL OR "verified_previous_retention_handle_id" IS NOT NULL) AND ("observed_pointer_state" IS NULL OR ("verified_target_retention_observed_status" = 'held' AND ("verified_previous_feature_release_id" IS NULL OR "verified_previous_retention_observed_status" = 'held')))) /* check_kind=state_field_consistency logical_columns=command_id,command_type,idempotency_domain,idempotency_key,request_value_id,request_hash,request_schema_resource_id,request_schema_hash,domain_request_hash,verified_compatibility_input_value_id,verified_compatibility_input_hash,verified_compatibility_input_schema_resource_id,verified_compatibility_input_schema_hash,verified_compatibility_result_value_id,verified_compatibility_result_hash,verified_compatibility_result_schema_resource_id,verified_compatibility_result_schema_hash,verified_feature_id,verified_target_feature_release_id,verified_target_feature_release_ref,verified_target_feature_release_version,verified_target_feature_release_hash,verified_previous_feature_release_id,verified_previous_feature_release_ref,verified_previous_feature_release_version,verified_previous_feature_release_hash,verified_target_retention_handle_id,verified_target_retention_handle_kind,verified_target_retention_feature_release_id,verified_target_retention_closure_manifest_id,verified_target_retention_closure_hash,verified_target_retention_observed_status,verified_target_retention_observed_row_version,verified_previous_retention_handle_id,verified_previous_retention_handle_kind,verified_previous_retention_feature_release_id,verified_previous_retention_closure_manifest_id,verified_previous_retention_closure_hash,verified_previous_retention_observed_status,verified_previous_retention_observed_row_version,observed_pointer_state,observed_pointer_row_version,observed_feature_release_id,observed_feature_release_ref,observed_feature_release_version,observed_feature_release_hash,terminal_disposition,canonical_terminal_result_value_id,canonical_terminal_result_hash,canonical_terminal_result_schema_resource_id,canonical_terminal_result_schema_hash,canonical_terminal_invocation_id,canonical_terminal_invocation_no,canonical_terminal_invocation_hash,canonical_terminal_submitted_request_hash,applied_pointer_row_version,canonical_receipt_value_id,canonical_receipt_hash,canonical_receipt_schema_resource_id,canonical_receipt_schema_hash,lifecycle,created_at_ms,finalized_at_ms,row_version */,
...
CREATE UNIQUE INDEX "uk:domain_claims:owner_resource" ON "workflow_domain_resource_claims" ("owner_workflow_id", "namespace", "key_hash");
