...
CREATE TABLE "workflow_value_ownerships" (
  ...
  "owner_pack_release_id" TEXT /* logical_type=identifier */,
  ...
  CONSTRAINT "fk:value_ownerships:pack_release" FOREIGN KEY ("owner_pack_release_id") REFERENCES "workflow_pack_releases" ("id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_value_ownerships:owner_workflow_id:owner_graph_run_id:owner_registry_resource_id:owner_pack_release_id:system_owner_ref:exactly_one" CHECK ((("owner_workflow_id" IS NOT NULL) + ("owner_graph_run_id" IS NOT NULL) + ("owner_registry_resource_id" IS NOT NULL) + ("owner_pack_release_id" IS NOT NULL) + ("system_owner_ref" IS NOT NULL)) = 1) /* check_kind=exactly_one logical_columns=owner_workflow_id,owner_graph_run_id,owner_registry_resource_id,owner_pack_release_id,system_owner_ref */
);
...
CREATE TABLE "workflow_registry_resources" (
  ...
  "owner_pack_id" TEXT /* logical_type=external_reference external_ref=1 validator_owner=pack_registry reference_domain=pack immutable=1 */,
  ...
  CONSTRAINT "ck:workflow_registry_resources:owner_core_ref:owner_pack_id:owner_principal_ref:exactly_one" CHECK ((("owner_core_ref" IS NOT NULL) + ("owner_pack_id" IS NOT NULL) + ("owner_principal_ref" IS NOT NULL)) = 1) /* check_kind=exactly_one logical_columns=owner_core_ref,owner_pack_id,owner_principal_ref */,
...
CREATE TABLE "workflow_pack_releases" (
  "id" TEXT NOT NULL /* logical_type=identifier */,
  "pack_id" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=pack_registry reference_domain=pack immutable=1 */,
  "release_ref" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=pack_release_ref_validator reference_domain=pack_release immutable=1 */,
  ...
  "row_version" INTEGER NOT NULL /* logical_type=integer */,
  CONSTRAINT "pk:workflow_pack_releases" PRIMARY KEY ("id"),
  CONSTRAINT "fk:pack_releases:execution_artifact" FOREIGN KEY ("execution_artifact_resource_id", "execution_artifact_hash") REFERENCES "workflow_registry_resources" ("id", "content_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "ck:workflow_pack_releases:release_hash:hash" CHECK (("release_hash" IS NULL OR (length("release_hash") = 71 AND substr("release_hash", 1, 7) = 'sha256:' AND substr("release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=release_hash */,
  CONSTRAINT "ck:workflow_pack_releases:execution_artifact_hash:hash" CHECK (("execution_artifact_hash" IS NULL OR (length("execution_artifact_hash") = 71 AND substr("execution_artifact_hash", 1, 7) = 'sha256:' AND substr("execution_artifact_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=execution_artifact_hash */,
  CONSTRAINT "ck:workflow_pack_releases:status:enum" CHECK ("status" IN ('staged', 'active', 'draining', 'disabled', 'deleting')) /* check_kind=enum_membership logical_columns=status */,
  CONSTRAINT "ck:workflow_pack_releases:staged_at_ms:safe_integer" CHECK (("staged_at_ms" IS NULL OR "staged_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=staged_at_ms */,
  CONSTRAINT "ck:workflow_pack_releases:activated_at_ms:safe_integer" CHECK (("activated_at_ms" IS NULL OR "activated_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=activated_at_ms */,
  CONSTRAINT "ck:workflow_pack_releases:disabled_at_ms:safe_integer" CHECK (("disabled_at_ms" IS NULL OR "disabled_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=disabled_at_ms */,
  CONSTRAINT "ck:workflow_pack_releases:row_version:safe_integer" CHECK (("row_version" IS NULL OR "row_version" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=row_version */,
  CONSTRAINT "ck:workflow_pack_releases:execution_artifact_resource_id:execution_artifact_hash:pair" CHECK ((("execution_artifact_resource_id" IS NULL AND "execution_artifact_hash" IS NULL) OR ("execution_artifact_resource_id" IS NOT NULL AND "execution_artifact_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=execution_artifact_resource_id,execution_artifact_hash */,
  CONSTRAINT "ck:pack_releases:lifecycle_timestamps" CHECK ((("status" = 'staged' AND "activated_at_ms" IS NULL AND "disabled_at_ms" IS NULL) OR ("status" IN ('active', 'draining') AND "activated_at_ms" IS NOT NULL AND "disabled_at_ms" IS NULL AND "staged_at_ms" <= "activated_at_ms") OR ("status" IN ('disabled', 'deleting') AND "activated_at_ms" IS NOT NULL AND "disabled_at_ms" IS NOT NULL AND "staged_at_ms" <= "activated_at_ms" AND "activated_at_ms" <= "disabled_at_ms"))) /* check_kind=state_field_consistency logical_columns=status,staged_at_ms,activated_at_ms,disabled_at_ms */
);

CREATE TABLE "workflow_pack_release_resources" (
  "release_id" TEXT NOT NULL /* logical_type=identifier */,
  "resource_id" TEXT NOT NULL /* logical_type=identifier */,
  "content_hash" TEXT NOT NULL /* logical_type=hash */,
  "resource_role" TEXT NOT NULL /* logical_type=text */,
  CONSTRAINT "pk:workflow_pack_release_resources" PRIMARY KEY ("release_id", "resource_id"),
  CONSTRAINT "fk:pack_release_resources:release" FOREIGN KEY ("release_id") REFERENCES "workflow_pack_releases" ("id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:pack_release_resources:resource" FOREIGN KEY ("resource_id", "content_hash") REFERENCES "workflow_registry_resources" ("id", "content_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "ck:workflow_pack_release_resources:content_hash:hash" CHECK (("content_hash" IS NULL OR (length("content_hash") = 71 AND substr("content_hash", 1, 7) = 'sha256:' AND substr("content_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=content_hash */
);

CREATE TABLE "workflow_pack_active_releases" (
  "pack_id" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=pack_registry reference_domain=pack immutable=1 */,
  "release_id" TEXT NOT NULL /* logical_type=identifier */,
  "release_hash" TEXT NOT NULL /* logical_type=hash */,
  "row_version" INTEGER NOT NULL /* logical_type=integer */,
  "activated_at_ms" INTEGER NOT NULL /* logical_type=integer */,
  CONSTRAINT "pk:workflow_pack_active_releases" PRIMARY KEY ("pack_id"),
  CONSTRAINT "fk:pack_active_releases:release" FOREIGN KEY ("release_id", "release_hash") REFERENCES "workflow_pack_releases" ("id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:pack_active_releases:owner_release" FOREIGN KEY ("pack_id", "release_id", "release_hash") REFERENCES "workflow_pack_releases" ("pack_id", "id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "ck:workflow_pack_active_releases:release_hash:hash" CHECK (("release_hash" IS NULL OR (length("release_hash") = 71 AND substr("release_hash", 1, 7) = 'sha256:' AND substr("release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=release_hash */,
  CONSTRAINT "ck:workflow_pack_active_releases:row_version:safe_integer" CHECK (("row_version" IS NULL OR "row_version" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=row_version */,
  CONSTRAINT "ck:workflow_pack_active_releases:activated_at_ms:safe_integer" CHECK (("activated_at_ms" IS NULL OR "activated_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=activated_at_ms */,
  CONSTRAINT "ck:pack_active_releases:positive_row_version" CHECK ("row_version" >= 1) /* check_kind=state_field_consistency logical_columns=row_version */
);
...
CREATE TABLE "workflow_personal_releases" (
  ...
  "personal_workflow_id" TEXT NOT NULL /* logical_type=text */,
  "release_ref" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=personal_workflow_registry reference_domain=personal_workflow_release immutable=1 */,
  "release_version" TEXT NOT NULL /* logical_type=text */,
  "release_hash" TEXT NOT NULL /* logical_type=hash */,
  "recipe_resource_id" TEXT NOT NULL /* logical_type=identifier */,
  "recipe_resource_hash" TEXT NOT NULL /* logical_type=hash */,
  "graph_template_resource_id" TEXT NOT NULL /* logical_type=identifier */,
  "graph_template_resource_hash" TEXT NOT NULL /* logical_type=hash */,
  ...
  "compiler_version" TEXT NOT NULL /* logical_type=text */,
  "policy_effect_envelope_json" TEXT NOT NULL /* logical_type=canonical_json */,
  "policy_effect_envelope_hash" TEXT NOT NULL /* logical_type=hash */,
  "status" TEXT NOT NULL /* logical_type=text */,
  "published_at_ms" INTEGER NOT NULL /* logical_type=integer */,
  "activated_at_ms" INTEGER /* logical_type=integer */,
  "row_version" INTEGER NOT NULL /* logical_type=integer */,
...
CREATE TABLE "workflow_personal_release_operations" (
  ...
  "idempotency_key" TEXT NOT NULL /* logical_type=text */,
  "operation_type" TEXT NOT NULL /* logical_type=text */,
  "owner_principal_ref" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=principal_identity_resolver reference_domain=principal immutable=1 */,
  "personal_workflow_id" TEXT NOT NULL /* logical_type=text */,
  "target_release_id" TEXT NOT NULL /* logical_type=identifier */,
  "target_release_hash" TEXT NOT NULL /* logical_type=hash */,
  "request_hash" TEXT NOT NULL /* logical_type=hash */,
  "disposition" TEXT NOT NULL /* logical_type=text */,
  "result_json" TEXT NOT NULL /* logical_type=canonical_json */,
  "failure_code" TEXT /* logical_type=text */,
  "requested_at_ms" INTEGER NOT NULL /* logical_type=integer */,
  "completed_at_ms" INTEGER NOT NULL /* logical_type=integer */,
  "row_version" INTEGER NOT NULL /* logical_type=integer */,
...
CREATE TABLE "workflow_registry_retention_handles" (
  ...
  "pack_release_id" TEXT /* logical_type=identifier */,
  "graph_run_id" TEXT /* logical_type=identifier */,
  ...
  CONSTRAINT "fk:retention_handles:pack_release" FOREIGN KEY ("pack_release_id") REFERENCES "workflow_pack_releases" ("id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_registry_retention_handles:pack_release_id:graph_run_id:backup_id:external_actor_ref:exactly_one" CHECK ((("pack_release_id" IS NOT NULL) + ("graph_run_id" IS NOT NULL) + ("backup_id" IS NOT NULL) + ("external_actor_ref" IS NOT NULL)) = 1) /* check_kind=exactly_one logical_columns=pack_release_id,graph_run_id,backup_id,external_actor_ref */,
  CONSTRAINT "ck:retention_handles:kind_root" CHECK ((("handle_kind" = 'published' AND "pack_release_id" IS NOT NULL) OR ("handle_kind" = 'active_run' AND "graph_run_id" IS NOT NULL) OR ("handle_kind" = 'manual_pin' AND ("backup_id" IS NOT NULL OR "external_actor_ref" IS NOT NULL)) OR ("handle_kind" = 'investigation' AND "external_actor_ref" IS NOT NULL))) /* check_kind=closed_target_mapping logical_columns=handle_kind,pack_release_id,graph_run_id,backup_id,external_actor_ref */,
...
CREATE TABLE "workflow_task_intakes" (
  ...
  CONSTRAINT "ck:workflow_task_intakes:source:enum" CHECK ("source" IN ('global_assistant', 'schedule', 'api', 'task_workspace', 'workflow_transition')) /* check_kind=enum_membership logical_columns=source */,
...
CREATE TABLE "workflow_task_intake_revisions" (
  ...
  CONSTRAINT "ck:workflow_task_intake_revisions:actor_kind:enum" CHECK ("actor_kind" IN ('human', 'pack_service', 'automation', 'system')) /* check_kind=enum_membership logical_columns=actor_kind */,
...
CREATE TABLE "workflows" (
  ...
  "creation_key" TEXT NOT NULL /* logical_type=text */,
  "owner_principal_ref" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=principal_identity_resolver reference_domain=principal immutable=1 */,
  "controlling_pack_id" TEXT /* logical_type=external_reference external_ref=1 validator_owner=pack_registry reference_domain=pack immutable=1 */,
...
CREATE TABLE "workflow_state_activations" (
  ...
  CONSTRAINT "ck:workflow_state_activations:terminal_kind:enum" CHECK ("terminal_kind" IN ('normal', 'errored', 'cancelled')) /* check_kind=enum_membership logical_columns=terminal_kind */,
  ...
  CONSTRAINT "ck:state_activations:terminal_shape" CHECK ((("terminal_kind" = 'normal' AND "terminal_output_value_id" IS NOT NULL AND "terminal_error_code" IS NULL AND "terminal_error_detail_value_id" IS NULL) OR ("terminal_kind" = 'errored' AND "terminal_output_value_id" IS NULL AND "terminal_error_code" IS NOT NULL) OR ("terminal_kind" = 'cancelled' AND "terminal_output_value_id" IS NULL AND "terminal_error_code" IS NULL AND "terminal_error_detail_value_id" IS NULL) OR ("terminal_kind" IS NULL AND "terminal_output_value_id" IS NULL AND "terminal_error_code" IS NULL AND "terminal_error_detail_value_id" IS NULL))) /* check_kind=state_field_consistency logical_columns=terminal_kind,terminal_output_value_id,terminal_error_code,terminal_error_detail_value_id */,
...
CREATE TABLE "workflow_provider_cancellation_requests" (
  ...
  "node_id" TEXT NOT NULL /* logical_type=identifier */,
  "attempt_id" TEXT NOT NULL /* logical_type=identifier */,
  "effect_operation_id" TEXT NOT NULL /* logical_type=identifier */,
  ...
  "adapter_ref_id" TEXT NOT NULL /* logical_type=text */,
  "external_execution_id" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=executor_adapter_registry reference_domain=external_execution immutable=1 */,
  "status" TEXT NOT NULL /* logical_type=text */,
  "attempt_count" INTEGER NOT NULL /* logical_type=integer */,
  "next_attempt_at_ms" INTEGER /* logical_type=integer */,
  "lease_owner" TEXT /* logical_type=external_reference external_ref=1 validator_owner=runtime_worker_registry reference_domain=worker_lease immutable=0 */,
  ...
  CONSTRAINT "ck:workflow_provider_cancellation_requests:adapter_resource_hash:hash" CHECK (length("adapter_resource_hash") = 71 AND substr("adapter_resource_hash", 1, 7) = 'sha256:' AND substr("adapter_resource_hash", 8) NOT GLOB '*[^0-9a-f]*'),
  CONSTRAINT "ck:workflow_provider_cancellation_requests:status:enum" CHECK ("status" IN ('requested', 'processing', 'retry_wait', 'acknowledged', 'not_required')),
  CONSTRAINT "ck:workflow_provider_cancellation_requests:attempt_count:safe_integer" CHECK ("attempt_count" BETWEEN 0 AND 9007199254740991),
  CONSTRAINT "ck:workflow_provider_cancellation_requests:next_attempt_at_ms:safe_integer" CHECK ("next_attempt_at_ms" IS NULL OR "next_attempt_at_ms" BETWEEN 0 AND 9007199254740991),
  CONSTRAINT "ck:workflow_provider_cancellation_requests:lease_expires_at_ms:safe_integer" CHECK ("lease_expires_at_ms" IS NULL OR "lease_expires_at_ms" BETWEEN 0 AND 9007199254740991),
  CONSTRAINT "ck:workflow_provider_cancellation_requests:requested_at_ms:safe_integer" CHECK ("requested_at_ms" BETWEEN 0 AND 9007199254740991),
  CONSTRAINT "ck:workflow_provider_cancellation_requests:settled_at_ms:safe_integer" CHECK ("settled_at_ms" IS NULL OR "settled_at_ms" BETWEEN 0 AND 9007199254740991),
  CONSTRAINT "ck:workflow_provider_cancellation_requests:updated_at_ms:safe_integer" CHECK ("updated_at_ms" BETWEEN 0 AND 9007199254740991),
  CONSTRAINT "ck:workflow_provider_cancellation_requests:row_version:safe_integer" CHECK ("row_version" BETWEEN 0 AND 9007199254740991),
  CONSTRAINT "ck:provider_cancellations:lease_owner:lease_token:pair" CHECK ((("lease_owner" IS NULL AND "lease_token" IS NULL) OR ("lease_owner" IS NOT NULL AND "lease_token" IS NOT NULL))),
  CONSTRAINT "ck:provider_cancellations:lease_owner:lease_expires_at_ms:pair" CHECK ((("lease_owner" IS NULL AND "lease_expires_at_ms" IS NULL) OR ("lease_owner" IS NOT NULL AND "lease_expires_at_ms" IS NOT NULL))),
...
CREATE TABLE "workflow_runtime_command_invocations" (
  ...
  "source_pack_id" TEXT /* logical_type=external_reference external_ref=1 validator_owner=pack_registry reference_domain=pack immutable=1 */,
  ...
  CONSTRAINT "ck:workflow_runtime_command_invocations:actor_kind:enum" CHECK ("actor_kind" IN ('human', 'pack_service', 'automation', 'system')) /* check_kind=enum_membership logical_columns=actor_kind */,
...
CREATE TABLE "runtime_capacity_admin_invocations" (
  ...
  CONSTRAINT "ck:runtime_capacity_admin_invocations:actor_kind:enum" CHECK ("actor_kind" IN ('human', 'pack_service', 'automation', 'system')) /* check_kind=enum_membership logical_columns=actor_kind */,
...
CREATE TABLE "workflow_publisher_commands" (
  ...
  "closure_manifest_id" TEXT NOT NULL /* logical_type=identifier */,
  "closure_hash" TEXT NOT NULL /* logical_type=hash */,
  "target_pack_release_id" TEXT NOT NULL /* logical_type=identifier */,
  "target_pack_release_hash" TEXT NOT NULL /* logical_type=hash */,
  "applied_pack_release_id" TEXT /* logical_type=identifier */,
  "applied_pack_release_hash" TEXT /* logical_type=hash */,
  ...
  CONSTRAINT "fk:publisher_commands:target_pack_release" FOREIGN KEY ("target_pack_release_id", "target_pack_release_hash") REFERENCES "workflow_pack_releases" ("id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:publisher_commands:applied_pack_release" FOREIGN KEY ("applied_pack_release_id", "applied_pack_release_hash") REFERENCES "workflow_pack_releases" ("id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_publisher_commands:target_pack_release_hash:hash" CHECK (("target_pack_release_hash" IS NULL OR (length("target_pack_release_hash") = 71 AND substr("target_pack_release_hash", 1, 7) = 'sha256:' AND substr("target_pack_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=target_pack_release_hash */,
  CONSTRAINT "ck:workflow_publisher_commands:applied_pack_release_hash:hash" CHECK (("applied_pack_release_hash" IS NULL OR (length("applied_pack_release_hash") = 71 AND substr("applied_pack_release_hash", 1, 7) = 'sha256:' AND substr("applied_pack_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=applied_pack_release_hash */,
  ...
  CONSTRAINT "ck:publisher_commands:applied_release_pair" CHECK ((("applied_pack_release_id" IS NULL AND "applied_pack_release_hash" IS NULL) OR ("applied_pack_release_id" IS NOT NULL AND "applied_pack_release_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=applied_pack_release_id,applied_pack_release_hash */,
  ...
  CONSTRAINT "ck:publisher_commands:lifecycle" CHECK ((("lifecycle" = 'pending' AND "applied_pack_release_id" IS NULL AND "applied_pack_release_hash" IS NULL AND "canonical_receipt_value_id" IS NULL AND "finalized_at_ms" IS NULL) OR ("lifecycle" = 'applied' AND "applied_pack_release_id" = "target_pack_release_id" AND "applied_pack_release_hash" = "target_pack_release_hash" AND "canonical_receipt_value_id" IS NOT NULL AND "finalized_at_ms" IS NOT NULL) OR ("lifecycle" = 'failed' AND "applied_pack_release_id" IS NULL AND "applied_pack_release_hash" IS NULL AND "canonical_receipt_value_id" IS NOT NULL AND "finalized_at_ms" IS NOT NULL))) /* check_kind=state_field_consistency logical_columns=lifecycle,target_pack_release_id,target_pack_release_hash,applied_pack_release_id,applied_pack_release_hash,canonical_receipt_value_id,finalized_at_ms */
);
...
CREATE TABLE "workflow_publisher_events" (
  ...
  "event_type" TEXT NOT NULL /* logical_type=text */,
  "failure_code" TEXT /* logical_type=text */,
  "related_pack_release_id" TEXT /* logical_type=identifier */,
  "related_pack_release_hash" TEXT /* logical_type=hash */,
  "detail_value_id" TEXT /* logical_type=identifier */,
  "detail_hash" TEXT /* logical_type=hash */,
  ...
  CONSTRAINT "fk:publisher_events:related_pack_release" FOREIGN KEY ("related_pack_release_id", "related_pack_release_hash") REFERENCES "workflow_pack_releases" ("id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_publisher_events:related_pack_release_hash:hash" CHECK (("related_pack_release_hash" IS NULL OR (length("related_pack_release_hash") = 71 AND substr("related_pack_release_hash", 1, 7) = 'sha256:' AND substr("related_pack_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=related_pack_release_hash */,
  ...
  CONSTRAINT "ck:publisher_events:related_release_pair" CHECK ((("related_pack_release_id" IS NULL AND "related_pack_release_hash" IS NULL) OR ("related_pack_release_id" IS NOT NULL AND "related_pack_release_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=related_pack_release_id,related_pack_release_hash */,
  ...
  CONSTRAINT "ck:publisher_events:event_mapping" CHECK ((("event_type" = 'attempt_started' AND "phase" = 'authenticate' AND "failure_code" IS NULL AND "related_pack_release_id" IS NULL) OR ("event_type" = 'phase_succeeded' AND "phase" IN ('validate', 'review', 'preflight', 'finalize') AND "failure_code" IS NULL AND "related_pack_release_id" IS NULL) OR ("event_type" = 'pre_transaction_failed' AND "phase" IN ('authenticate', 'validate', 'review', 'preflight') AND "failure_code" IS NOT NULL AND "related_pack_release_id" IS NULL) OR ("event_type" = 'publish_transaction_started' AND "phase" = 'publish_transaction' AND "failure_code" IS NULL AND "related_pack_release_id" IS NULL) OR ("event_type" = 'publish_committed' AND "phase" = 'publish_transaction' AND "failure_code" IS NULL AND "related_pack_release_id" IS NOT NULL) OR ("event_type" = 'recovery_started' AND "phase" = 'recovery' AND "failure_code" IS NULL AND "related_pack_release_id" IS NULL) OR ("event_type" = 'recovery_succeeded' AND "phase" = 'recovery' AND "failure_code" IS NULL AND "related_pack_release_id" IS NOT NULL) OR ("event_type" = 'recovery_failed' AND "phase" = 'recovery' AND "failure_code" IS NOT NULL AND "related_pack_release_id" IS NULL) OR ("event_type" = 'terminal_failed' AND "phase" = 'finalize' AND "failure_code" IS NOT NULL AND "related_pack_release_id" IS NULL))) /* check_kind=closed_target_mapping logical_columns=phase,event_type,failure_code,related_pack_release_id */
);

CREATE TABLE "workflow_pack_release_activation_commands" (
  "command_id" TEXT NOT NULL /* logical_type=identifier */,
  "command_type" TEXT NOT NULL /* logical_type=text */,
  "idempotency_domain" TEXT NOT NULL /* logical_type=text */,
  "idempotency_key" TEXT NOT NULL /* logical_type=text */,
  ...
  "request_schema_hash" TEXT NOT NULL /* logical_type=hash */,
  "domain_request_hash" TEXT NOT NULL /* logical_type=hash */,
  "verified_pack_id" TEXT /* logical_type=external_reference external_ref=1 validator_owner=pack_registry reference_domain=pack immutable=1 */,
  "verified_target_pack_release_id" TEXT /* logical_type=identifier */,
  "verified_target_pack_release_ref" TEXT /* logical_type=external_reference external_ref=1 validator_owner=pack_release_ref_validator reference_domain=pack_release immutable=1 */,
  "verified_target_pack_release_version" TEXT /* logical_type=text */,
  "verified_target_pack_release_hash" TEXT /* logical_type=hash */,
  "verified_previous_pack_release_id" TEXT /* logical_type=identifier */,
  "verified_previous_pack_release_ref" TEXT /* logical_type=external_reference external_ref=1 validator_owner=pack_release_ref_validator reference_domain=pack_release immutable=1 */,
  "verified_previous_pack_release_version" TEXT /* logical_type=text */,
  "verified_previous_pack_release_hash" TEXT /* logical_type=hash */,
  ...
  "verified_target_retention_pack_release_id" TEXT /* logical_type=identifier */,
  ...
  "verified_previous_retention_pack_release_id" TEXT /* logical_type=identifier */,
  ...
  "observed_pack_release_id" TEXT /* logical_type=identifier */,
  "observed_pack_release_ref" TEXT /* logical_type=external_reference external_ref=1 validator_owner=pack_release_ref_validator reference_domain=pack_release immutable=1 */,
  "observed_pack_release_version" TEXT /* logical_type=text */,
  "observed_pack_release_hash" TEXT /* logical_type=hash */,
  ...
  "finalized_at_ms" INTEGER /* logical_type=integer */,
  "row_version" INTEGER NOT NULL /* logical_type=integer */,
  CONSTRAINT "pk:workflow_pack_release_activation_commands" PRIMARY KEY ("command_id"),
  ...
  CONSTRAINT "fk:activation_commands:verified_target_release" FOREIGN KEY ("verified_pack_id", "verified_target_pack_release_id", "verified_target_pack_release_hash") REFERENCES "workflow_pack_releases" ("pack_id", "id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:activation_commands:verified_previous_release" FOREIGN KEY ("verified_pack_id", "verified_previous_pack_release_id", "verified_previous_pack_release_hash") REFERENCES "workflow_pack_releases" ("pack_id", "id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:activation_commands:observed_release" FOREIGN KEY ("verified_pack_id", "observed_pack_release_id", "observed_pack_release_hash") REFERENCES "workflow_pack_releases" ("pack_id", "id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:activation_commands:verified_target_retention" FOREIGN KEY ("verified_target_retention_handle_id", "verified_target_retention_handle_kind", "verified_target_retention_pack_release_id", "verified_target_retention_closure_manifest_id", "verified_target_retention_closure_hash") REFERENCES "workflow_registry_retention_handles" ("id", "handle_kind", "pack_release_id", "closure_manifest_id", "closure_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:activation_commands:verified_previous_retention" FOREIGN KEY ("verified_previous_retention_handle_id", "verified_previous_retention_handle_kind", "verified_previous_retention_pack_release_id", "verified_previous_retention_closure_manifest_id", "verified_previous_retention_closure_hash") REFERENCES "workflow_registry_retention_handles" ("id", "handle_kind", "pack_release_id", "closure_manifest_id", "closure_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_pack_release_activation_commands:command_type:enum" CHECK ("command_type" IN ('activate_pack_release')) /* check_kind=enum_membership logical_columns=command_type */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:request_hash:hash" CHECK (("request_hash" IS NULL OR (length("request_hash") = 71 AND substr("request_hash", 1, 7) = 'sha256:' AND substr("request_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=request_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:request_schema_hash:hash" CHECK (("request_schema_hash" IS NULL OR (length("request_schema_hash") = 71 AND substr("request_schema_hash", 1, 7) = 'sha256:' AND substr("request_schema_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=request_schema_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:domain_request_hash:hash" CHECK (("domain_request_hash" IS NULL OR (length("domain_request_hash") = 71 AND substr("domain_request_hash", 1, 7) = 'sha256:' AND substr("domain_request_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=domain_request_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:verified_target_pack_release_hash:hash" CHECK (("verified_target_pack_release_hash" IS NULL OR (length("verified_target_pack_release_hash") = 71 AND substr("verified_target_pack_release_hash", 1, 7) = 'sha256:' AND substr("verified_target_pack_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_target_pack_release_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:verified_previous_pack_release_hash:hash" CHECK (("verified_previous_pack_release_hash" IS NULL OR (length("verified_previous_pack_release_hash") = 71 AND substr("verified_previous_pack_release_hash", 1, 7) = 'sha256:' AND substr("verified_previous_pack_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_previous_pack_release_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:verified_target_retention_handle_kind:enum" CHECK ("verified_target_retention_handle_kind" IN ('published')) /* check_kind=enum_membership logical_columns=verified_target_retention_handle_kind */,
  ...
  CONSTRAINT "ck:workflow_pack_release_activation_commands:verified_target_retention_observed_status:enum" CHECK ("verified_target_retention_observed_status" IN ('held')) /* check_kind=enum_membership logical_columns=verified_target_retention_observed_status */,
  ...
  CONSTRAINT "ck:workflow_pack_release_activation_commands:verified_previous_retention_handle_kind:enum" CHECK ("verified_previous_retention_handle_kind" IN ('published')) /* check_kind=enum_membership logical_columns=verified_previous_retention_handle_kind */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:verified_previous_retention_closure_hash:hash" CHECK (("verified_previous_retention_closure_hash" IS NULL OR (length("verified_previous_retention_closure_hash") = 71 AND substr("verified_previous_retention_closure_hash", 1, 7) = 'sha256:' AND substr("verified_previous_retention_closure_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_previous_retention_closure_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:verified_previous_retention_observed_status:enum" CHECK ("verified_previous_retention_observed_status" IN ('held')) /* check_kind=enum_membership logical_columns=verified_previous_retention_observed_status */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:verified_previous_retention_observed_row_version:safe_integer" CHECK (("verified_previous_retention_observed_row_version" IS NULL OR "verified_previous_retention_observed_row_version" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=verified_previous_retention_observed_row_version */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:observed_pointer_state:enum" CHECK ("observed_pointer_state" IN ('absent', 'present')) /* check_kind=enum_membership logical_columns=observed_pointer_state */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:observed_pointer_row_version:safe_integer" CHECK (("observed_pointer_row_version" IS NULL OR "observed_pointer_row_version" BETWEEN 1 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=observed_pointer_row_version */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:observed_pack_release_hash:hash" CHECK (("observed_pack_release_hash" IS NULL OR (length("observed_pack_release_hash") = 71 AND substr("observed_pack_release_hash", 1, 7) = 'sha256:' AND substr("observed_pack_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=observed_pack_release_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:terminal_disposition:enum" CHECK ("terminal_disposition" IN ('applied', 'failed', 'conflict')) /* check_kind=enum_membership logical_columns=terminal_disposition */,
  ...
  CONSTRAINT "ck:workflow_pack_release_activation_commands:canonical_terminal_invocation_no:safe_integer" CHECK (("canonical_terminal_invocation_no" IS NULL OR "canonical_terminal_invocation_no" BETWEEN 1 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=canonical_terminal_invocation_no */,
  ...
  CONSTRAINT "ck:workflow_pack_release_activation_commands:applied_pointer_row_version:safe_integer" CHECK (("applied_pointer_row_version" IS NULL OR "applied_pointer_row_version" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=applied_pointer_row_version */,
  ...
  CONSTRAINT "ck:workflow_pack_release_activation_commands:lifecycle:enum" CHECK ("lifecycle" IN ('pending', 'applied', 'failed', 'conflict')) /* check_kind=enum_membership logical_columns=lifecycle */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:created_at_ms:safe_integer" CHECK (("created_at_ms" IS NULL OR "created_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=created_at_ms */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:finalized_at_ms:safe_integer" CHECK (("finalized_at_ms" IS NULL OR "finalized_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=finalized_at_ms */,
  CONSTRAINT "ck:workflow_pack_release_activation_commands:row_version:safe_integer" CHECK (("row_version" IS NULL OR "row_version" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=row_version */,
  ...
  CONSTRAINT "ck:activation_commands:verified_target_release" CHECK ((("verified_pack_id" IS NULL AND "verified_target_pack_release_id" IS NULL AND "verified_target_pack_release_ref" IS NULL AND "verified_target_pack_release_version" IS NULL AND "verified_target_pack_release_hash" IS NULL) OR ("verified_pack_id" IS NOT NULL AND "verified_target_pack_release_id" IS NOT NULL AND "verified_target_pack_release_ref" IS NOT NULL AND "verified_target_pack_release_version" IS NOT NULL AND "verified_target_pack_release_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=verified_pack_id,verified_target_pack_release_id,verified_target_pack_release_ref,verified_target_pack_release_version,verified_target_pack_release_hash */,
  CONSTRAINT "ck:activation_commands:verified_previous_release" CHECK ((("verified_previous_pack_release_id" IS NULL AND "verified_previous_pack_release_ref" IS NULL AND "verified_previous_pack_release_version" IS NULL AND "verified_previous_pack_release_hash" IS NULL) OR ("verified_previous_pack_release_id" IS NOT NULL AND "verified_previous_pack_release_ref" IS NOT NULL AND "verified_previous_pack_release_version" IS NOT NULL AND "verified_previous_pack_release_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=verified_previous_pack_release_id,verified_previous_pack_release_ref,verified_previous_pack_release_version,verified_previous_pack_release_hash */,
  CONSTRAINT "ck:activation_commands:verified_target_retention_identity" CHECK ((("verified_target_retention_handle_id" IS NULL AND "verified_target_retention_handle_kind" IS NULL AND "verified_target_retention_pack_release_id" IS NULL AND "verified_target_retention_closure_manifest_id" IS NULL AND "verified_target_retention_closure_hash" IS NULL) OR ("verified_target_retention_handle_id" IS NOT NULL AND "verified_target_retention_handle_kind" IS NOT NULL AND "verified_target_retention_pack_release_id" IS NOT NULL AND "verified_target_retention_closure_manifest_id" IS NOT NULL AND "verified_target_retention_closure_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=verified_target_retention_handle_id,verified_target_retention_handle_kind,verified_target_retention_pack_release_id,verified_target_retention_closure_manifest_id,verified_target_retention_closure_hash */,
  ...
  CONSTRAINT "ck:activation_commands:verified_previous_retention_identity" CHECK ((("verified_previous_retention_handle_id" IS NULL AND "verified_previous_retention_handle_kind" IS NULL AND "verified_previous_retention_pack_release_id" IS NULL AND "verified_previous_retention_closure_manifest_id" IS NULL AND "verified_previous_retention_closure_hash" IS NULL) OR ("verified_previous_retention_handle_id" IS NOT NULL AND "verified_previous_retention_handle_kind" IS NOT NULL AND "verified_previous_retention_pack_release_id" IS NOT NULL AND "verified_previous_retention_closure_manifest_id" IS NOT NULL AND "verified_previous_retention_closure_hash" IS NOT NULL))) /* check_kind=all_or_none logical_columns=verified_previous_retention_handle_id,verified_previous_retention_handle_kind,verified_previous_retention_pack_release_id,verified_previous_retention_closure_manifest_id,verified_previous_retention_closure_hash */,
  ...
  CONSTRAINT "ck:activation_commands:pointer_observation_shape" CHECK ((("observed_pointer_state" IS NULL AND "observed_pointer_row_version" IS NULL AND "observed_pack_release_id" IS NULL AND "observed_pack_release_ref" IS NULL AND "observed_pack_release_version" IS NULL AND "observed_pack_release_hash" IS NULL) OR ("observed_pointer_state" = 'absent' AND "observed_pointer_row_version" IS NULL AND "observed_pack_release_id" IS NULL AND "observed_pack_release_ref" IS NULL AND "observed_pack_release_version" IS NULL AND "observed_pack_release_hash" IS NULL) OR ("observed_pointer_state" = 'present' AND "observed_pointer_row_version" IS NOT NULL AND "observed_pack_release_id" IS NOT NULL AND "observed_pack_release_ref" IS NOT NULL AND "observed_pack_release_version" IS NOT NULL AND "observed_pack_release_hash" IS NOT NULL))) /* check_kind=closed_target_mapping logical_columns=observed_pointer_state,observed_pointer_row_version,observed_pack_release_id,observed_pack_release_ref,observed_pack_release_version,observed_pack_release_hash */,
  CONSTRAINT "ck:activation_commands:target_previous_distinct" CHECK (("verified_previous_pack_release_id" IS NULL OR "verified_target_pack_release_id" <> "verified_previous_pack_release_id")) /* check_kind=cross_column_equality logical_columns=verified_target_pack_release_id,verified_previous_pack_release_id */,
  CONSTRAINT "ck:activation_commands:verified_prefix" CHECK (("verified_previous_pack_release_id" IS NULL OR "verified_target_pack_release_id" IS NOT NULL) AND ("verified_target_retention_handle_id" IS NULL OR ("verified_target_pack_release_id" IS NOT NULL AND "verified_target_retention_pack_release_id" = "verified_target_pack_release_id")) AND ("verified_target_retention_observed_status" IS NULL OR "verified_target_retention_handle_id" IS NOT NULL) AND ("verified_previous_retention_handle_id" IS NULL OR ("verified_previous_pack_release_id" IS NOT NULL AND "verified_target_retention_observed_status" = 'held' AND "verified_previous_retention_pack_release_id" = "verified_previous_pack_release_id")) AND ("verified_previous_retention_observed_status" IS NULL OR "verified_previous_retention_handle_id" IS NOT NULL) AND ("observed_pointer_state" IS NULL OR ("verified_target_retention_observed_status" = 'held' AND ("verified_previous_pack_release_id" IS NULL OR "verified_previous_retention_observed_status" = 'held')))),
  CONSTRAINT "ck:activation_commands:lifecycle" CHECK ((("lifecycle" = 'pending' AND "terminal_disposition" IS NULL AND "canonical_terminal_result_value_id" IS NULL AND "canonical_terminal_invocation_id" IS NULL AND "applied_pointer_row_version" IS NULL AND "canonical_receipt_value_id" IS NULL AND "finalized_at_ms" IS NULL AND ("row_version" <> 0 OR ("verified_target_pack_release_id" IS NULL AND "verified_previous_pack_release_id" IS NULL AND "verified_target_retention_handle_id" IS NULL AND "verified_previous_retention_handle_id" IS NULL AND "observed_pointer_state" IS NULL))) OR ("lifecycle" = 'applied' AND "terminal_disposition" = 'applied' AND "observed_pointer_state" IS NOT NULL AND "canonical_terminal_result_value_id" IS NOT NULL AND "canonical_terminal_invocation_id" IS NOT NULL AND "applied_pointer_row_version" IS NOT NULL AND "canonical_receipt_value_id" IS NOT NULL AND "finalized_at_ms" IS NOT NULL) OR ("lifecycle" IN ('failed', 'conflict') AND "terminal_disposition" = "lifecycle" AND "canonical_terminal_result_value_id" IS NOT NULL AND "canonical_terminal_invocation_id" IS NOT NULL AND "applied_pointer_row_version" IS NULL AND "canonical_receipt_value_id" IS NULL AND "finalized_at_ms" IS NOT NULL)))
);

CREATE TABLE "workflow_pack_release_activation_invocations" (
  "id" TEXT NOT NULL /* logical_type=identifier */,
  "command_id" TEXT NOT NULL /* logical_type=identifier */,
  "invocation_no" INTEGER NOT NULL /* logical_type=integer */,
  ...
  "command_domain_request_hash" TEXT NOT NULL /* logical_type=hash */,
  "submitted_request_hash" TEXT NOT NULL /* logical_type=hash */,
  "actor_ref" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=pack_release_activation_authentication_gateway reference_domain=authenticated_principal immutable=1 */,
  "auth_session_ref" TEXT NOT NULL /* logical_type=external_reference external_ref=1 validator_owner=authentication_service reference_domain=auth_session immutable=1 */,
  "requested_at_ms" INTEGER NOT NULL /* logical_type=integer */,
  "disposition" TEXT NOT NULL /* logical_type=text */,
  "result_value_id" TEXT NOT NULL /* logical_type=identifier */,
  ...
  "previous_invocation_hash" TEXT /* logical_type=hash */,
  "invocation_hash" TEXT NOT NULL /* logical_type=hash */,
  CONSTRAINT "pk:workflow_pack_release_activation_invocations" PRIMARY KEY ("id"),
  CONSTRAINT "fk:activation_invocations:command_request" FOREIGN KEY ("command_id", "command_domain_request_hash") REFERENCES "workflow_pack_release_activation_commands" ("command_id", "domain_request_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:invocation_no:safe_integer" CHECK (("invocation_no" IS NULL OR "invocation_no" BETWEEN 1 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=invocation_no */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:invocation_kind:enum" CHECK ("invocation_kind" IN ('submit', 'recovery')) /* check_kind=enum_membership logical_columns=invocation_kind */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:command_domain_request_hash:hash" CHECK (("command_domain_request_hash" IS NULL OR (length("command_domain_request_hash") = 71 AND substr("command_domain_request_hash", 1, 7) = 'sha256:' AND substr("command_domain_request_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=command_domain_request_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:submitted_request_hash:hash" CHECK (("submitted_request_hash" IS NULL OR (length("submitted_request_hash") = 71 AND substr("submitted_request_hash", 1, 7) = 'sha256:' AND substr("submitted_request_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=submitted_request_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:requested_at_ms:safe_integer" CHECK (("requested_at_ms" IS NULL OR "requested_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=requested_at_ms */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:disposition:enum" CHECK ("disposition" IN ('applied', 'duplicate', 'conflict', 'failed')) /* check_kind=enum_membership logical_columns=disposition */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:result_hash:hash" CHECK (("result_hash" IS NULL OR (length("result_hash") = 71 AND substr("result_hash", 1, 7) = 'sha256:' AND substr("result_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=result_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:result_schema_hash:hash" CHECK (("result_schema_hash" IS NULL OR (length("result_schema_hash") = 71 AND substr("result_schema_hash", 1, 7) = 'sha256:' AND substr("result_schema_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=result_schema_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:referenced_terminal_result_hash:hash" CHECK (("referenced_terminal_result_hash" IS NULL OR (length("referenced_terminal_result_hash") = 71 AND substr("referenced_terminal_result_hash", 1, 7) = 'sha256:' AND substr("referenced_terminal_result_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=referenced_terminal_result_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:referenced_terminal_result_schema_hash:hash" CHECK (("referenced_terminal_result_schema_hash" IS NULL OR (length("referenced_terminal_result_schema_hash") = 71 AND substr("referenced_terminal_result_schema_hash", 1, 7) = 'sha256:' AND substr("referenced_terminal_result_schema_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=referenced_terminal_result_schema_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:decided_at_ms:safe_integer" CHECK (("decided_at_ms" IS NULL OR "decided_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=decided_at_ms */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:applied_at_ms:safe_integer" CHECK (("applied_at_ms" IS NULL OR "applied_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=applied_at_ms */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:previous_invocation_hash:hash" CHECK (("previous_invocation_hash" IS NULL OR (length("previous_invocation_hash") = 71 AND substr("previous_invocation_hash", 1, 7) = 'sha256:' AND substr("previous_invocation_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=previous_invocation_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_invocations:invocation_hash:hash" CHECK (("invocation_hash" IS NULL OR (length("invocation_hash") = 71 AND substr("invocation_hash", 1, 7) = 'sha256:' AND substr("invocation_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=invocation_hash */,
...
CREATE TABLE "workflow_pack_release_activation_events" (
  "command_id" TEXT NOT NULL /* logical_type=identifier */,
  "event_no" INTEGER NOT NULL /* logical_type=integer */,
  "attempt_no" INTEGER NOT NULL /* logical_type=integer */,
  "phase" TEXT NOT NULL /* logical_type=text */,
  ...
  "event_hash" TEXT NOT NULL /* logical_type=hash */,
  "occurred_at_ms" INTEGER NOT NULL /* logical_type=integer */,
  CONSTRAINT "pk:workflow_pack_release_activation_events" PRIMARY KEY ("command_id", "event_no"),
  CONSTRAINT "fk:activation_events:command" FOREIGN KEY ("command_id") REFERENCES "workflow_pack_release_activation_commands" ("command_id") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:activation_events:attempt_invocation" FOREIGN KEY ("command_id", "attempt_no") REFERENCES "workflow_pack_release_activation_invocations" ("command_id", "invocation_no") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:activation_events:verified_target_release" FOREIGN KEY ("verified_pack_id", "verified_target_pack_release_id", "verified_target_pack_release_hash") REFERENCES "workflow_pack_releases" ("pack_id", "id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  CONSTRAINT "fk:activation_events:verified_previous_release" FOREIGN KEY ("verified_pack_id", "verified_previous_pack_release_id", "verified_previous_pack_release_hash") REFERENCES "workflow_pack_releases" ("pack_id", "id", "release_hash") ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED,
  ...
  CONSTRAINT "ck:workflow_pack_release_activation_events:event_no:safe_integer" CHECK (("event_no" IS NULL OR "event_no" BETWEEN 1 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=event_no */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:attempt_no:safe_integer" CHECK (("attempt_no" IS NULL OR "attempt_no" BETWEEN 1 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=attempt_no */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:phase:enum" CHECK ("phase" IN ('authenticate', 'validate', 'preflight', 'activation_transaction', 'recovery', 'finalize')) /* check_kind=enum_membership logical_columns=phase */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:event_type:enum" CHECK ("event_type" IN ('attempt_started', 'phase_succeeded', 'pre_transaction_failed', 'activation_transaction_started', 'activation_committed', 'domain_request_conflicted', 'pointer_cas_conflicted', 'terminal_result_committed', 'terminal_replayed', 'recovery_started', 'recovery_succeeded', 'recovery_failed', 'integrity_failed')) /* check_kind=enum_membership logical_columns=event_type */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:verified_target_pack_release_hash:hash" CHECK (("verified_target_pack_release_hash" IS NULL OR (length("verified_target_pack_release_hash") = 71 AND substr("verified_target_pack_release_hash", 1, 7) = 'sha256:' AND substr("verified_target_pack_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_target_pack_release_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:verified_previous_pack_release_hash:hash" CHECK (("verified_previous_pack_release_hash" IS NULL OR (length("verified_previous_pack_release_hash") = 71 AND substr("verified_previous_pack_release_hash", 1, 7) = 'sha256:' AND substr("verified_previous_pack_release_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=verified_previous_pack_release_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:detail_hash:hash" CHECK (("detail_hash" IS NULL OR (length("detail_hash") = 71 AND substr("detail_hash", 1, 7) = 'sha256:' AND substr("detail_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=detail_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:detail_schema_hash:hash" CHECK (("detail_schema_hash" IS NULL OR (length("detail_schema_hash") = 71 AND substr("detail_schema_hash", 1, 7) = 'sha256:' AND substr("detail_schema_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=detail_schema_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:previous_event_hash:hash" CHECK (("previous_event_hash" IS NULL OR (length("previous_event_hash") = 71 AND substr("previous_event_hash", 1, 7) = 'sha256:' AND substr("previous_event_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=previous_event_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:event_hash:hash" CHECK (("event_hash" IS NULL OR (length("event_hash") = 71 AND substr("event_hash", 1, 7) = 'sha256:' AND substr("event_hash", 8) NOT GLOB '*[^0-9a-f]*'))) /* check_kind=hash_format logical_columns=event_hash */,
  CONSTRAINT "ck:workflow_pack_release_activation_events:occurred_at_ms:safe_integer" CHECK (("occurred_at_ms" IS NULL OR "occurred_at_ms" BETWEEN 0 AND 9007199254740991)) /* check_kind=safe_integer logical_columns=occurred_at_ms */,
  CONSTRAINT "ck:activation_events:verified_release_binding" CHECK ((("verified_pack_id" IS NULL AND "verified_target_pack_release_id" IS NULL AND "verified_target_pack_release_ref" IS NULL AND "verified_target_pack_release_version" IS NULL AND "verified_target_pack_release_hash" IS NULL AND "verified_previous_pack_release_id" IS NULL AND "verified_previous_pack_release_ref" IS NULL AND "verified_previous_pack_release_version" IS NULL AND "verified_previous_pack_release_hash" IS NULL) OR ("verified_pack_id" IS NOT NULL AND "verified_target_pack_release_id" IS NOT NULL AND "verified_target_pack_release_ref" IS NOT NULL AND "verified_target_pack_release_version" IS NOT NULL AND "verified_target_pack_release_hash" IS NOT NULL AND (("verified_previous_pack_release_id" IS NULL AND "verified_previous_pack_release_ref" IS NULL AND "verified_previous_pack_release_version" IS NULL AND "verified_previous_pack_release_hash" IS NULL) OR ("verified_previous_pack_release_id" IS NOT NULL AND "verified_previous_pack_release_ref" IS NOT NULL AND "verified_previous_pack_release_version" IS NOT NULL AND "verified_previous_pack_release_hash" IS NOT NULL))))) /* check_kind=closed_target_mapping logical_columns=verified_pack_id,verified_target_pack_release_id,verified_target_pack_release_ref,verified_target_pack_release_version,verified_target_pack_release_hash,verified_previous_pack_release_id,verified_previous_pack_release_ref,verified_previous_pack_release_version,verified_previous_pack_release_hash */,
...
CREATE TABLE "workflow_runtime_command_ingress_invocations" (
  ...
  CONSTRAINT "ck:workflow_runtime_command_ingress_invocations:actor_kind:enum" CHECK ("actor_kind" IN ('human', 'pack_service', 'automation', 'system')) /* check_kind=enum_membership logical_columns=actor_kind */,
  CONSTRAINT "ck:workflow_runtime_command_ingress_invocations:entrypoint:enum" CHECK ("entrypoint" IN ('runtime_center', 'pack_page', 'pack_host_api', 'external_api', 'automation', 'task_workspace', 'card_action', 'deadline_watchdog')) /* check_kind=enum_membership logical_columns=entrypoint */,
...
CREATE UNIQUE INDEX "uk:pack_releases:pack_ref" ON "workflow_pack_releases" ("pack_id", "release_ref", "release_version");

CREATE UNIQUE INDEX "uk:pack_releases:id_hash" ON "workflow_pack_releases" ("id", "release_hash");

CREATE UNIQUE INDEX "uk:pack_releases:owner_identity" ON "workflow_pack_releases" ("pack_id", "id", "release_hash");

CREATE UNIQUE INDEX "uk:pack_releases:single_active" ON "workflow_pack_releases" ("pack_id") WHERE "status" = 'active';
...
CREATE UNIQUE INDEX "uk:retention_handles:pack" ON "workflow_registry_retention_handles" ("handle_kind", "pack_release_id", "closure_manifest_id") WHERE "pack_release_id" IS NOT NULL;
...
CREATE UNIQUE INDEX "uk:retention_handles:published_identity" ON "workflow_registry_retention_handles" ("id", "handle_kind", "pack_release_id", "closure_manifest_id", "closure_hash");
...
CREATE UNIQUE INDEX "uk:activation_commands:idempotency" ON "workflow_pack_release_activation_commands" ("idempotency_domain", "idempotency_key");

CREATE UNIQUE INDEX "uk:activation_commands:id_domain_request" ON "workflow_pack_release_activation_commands" ("command_id", "domain_request_hash");

CREATE UNIQUE INDEX "uk:activation_invocations:command_no" ON "workflow_pack_release_activation_invocations" ("command_id", "invocation_no");

CREATE UNIQUE INDEX "uk:activation_invocations:invocation_hash" ON "workflow_pack_release_activation_invocations" ("invocation_hash");

CREATE UNIQUE INDEX "uk:activation_invocations:terminal_binding" ON "workflow_pack_release_activation_invocations" ("id", "command_id", "invocation_no", "command_domain_request_hash", "disposition", "invocation_hash", "submitted_request_hash", "result_value_id", "result_hash", "result_schema_resource_id", "result_schema_hash");

CREATE UNIQUE INDEX "uk:activation_events:attempt_phase_type" ON "workflow_pack_release_activation_events" ("command_id", "attempt_no", "phase", "event_type");

CREATE UNIQUE INDEX "uk:activation_events:event_hash" ON "workflow_pack_release_activation_events" ("event_hash");
...
CREATE INDEX "idx:pack_releases:activation_preflight" ON "workflow_pack_releases" ("pack_id", "id", "release_hash", "status");

CREATE INDEX "idx:pack_active_releases:activation_cas" ON "workflow_pack_active_releases" ("pack_id", "row_version", "release_id", "release_hash");

CREATE INDEX "idx:retention_handles:activation_preflight" ON "workflow_registry_retention_handles" ("pack_release_id", "handle_kind", "status", "closure_manifest_id", "closure_hash", "row_version", "id");
...
CREATE INDEX "idx:activation_commands:idempotency" ON "workflow_pack_release_activation_commands" ("idempotency_domain", "idempotency_key");

CREATE INDEX "idx:activation_commands:terminal_result" ON "workflow_pack_release_activation_commands" ("command_id", "terminal_disposition", "canonical_terminal_invocation_no") WHERE "lifecycle" IN ('applied', 'failed', 'conflict');

CREATE INDEX "idx:activation_commands:pending_recovery" ON "workflow_pack_release_activation_commands" ("created_at_ms", "command_id") WHERE "lifecycle" = 'pending';

CREATE INDEX "idx:activation_invocations:command_history" ON "workflow_pack_release_activation_invocations" ("command_id", "invocation_no");

CREATE INDEX "idx:activation_events:command_history" ON "workflow_pack_release_activation_events" ("command_id", "event_no");
...
CREATE TRIGGER "trg:publisher_commands:immutable_identity" BEFORE UPDATE OF "command_type", "idempotency_domain", "idempotency_key", "request_value_id", "request_hash", "request_schema_resource_id", "request_schema_hash", "domain_request_hash", "approved_review_ref", "approved_review_hash", "reviewer_actor_ref", "reviewer_auth_session_ref", "approved_at_ms", "expires_at_ms", "source_manifest_value_id", "source_manifest_hash", "source_manifest_schema_resource_id", "source_manifest_schema_hash", "compiled_plan_value_id", "compiled_plan_hash", "compiled_plan_schema_resource_id", "compiled_plan_schema_hash", "execution_artifact_resource_id", "execution_artifact_hash", "closure_manifest_id", "closure_hash", "target_pack_release_id", "target_pack_release_hash", "created_at_ms" ON "workflow_publisher_commands" BEGIN
...
CREATE TRIGGER "trg:pack_releases:immutable_identity" BEFORE UPDATE OF "id", "pack_id", "release_ref", "release_version", "release_hash", "execution_artifact_resource_id", "execution_artifact_hash", "staged_at_ms" ON "workflow_pack_releases" BEGIN
  SELECT RAISE(ABORT, 'pack_release_identity_is_immutable');
END;

CREATE TRIGGER "trg:pack_releases:lifecycle_transition" BEFORE UPDATE OF "status", "activated_at_ms", "disabled_at_ms", "row_version" ON "workflow_pack_releases" BEGIN
  SELECT CASE WHEN NEW."row_version" <> OLD."row_version" + 1 OR NOT ((OLD."status" = 'staged' AND NEW."status" = 'active' AND NEW."activated_at_ms" IS NOT NULL AND NEW."disabled_at_ms" IS NULL) OR (OLD."status" = 'active' AND NEW."status" = 'draining' AND NEW."activated_at_ms" IS OLD."activated_at_ms" AND NEW."disabled_at_ms" IS NULL) OR (OLD."status" = 'draining' AND NEW."status" = 'active' AND NEW."activated_at_ms" IS OLD."activated_at_ms" AND NEW."disabled_at_ms" IS NULL) OR (OLD."status" = 'draining' AND NEW."status" = 'disabled' AND NEW."activated_at_ms" IS OLD."activated_at_ms" AND NEW."disabled_at_ms" IS NOT NULL) OR (OLD."status" = 'disabled' AND NEW."status" = 'active' AND NEW."activated_at_ms" IS OLD."activated_at_ms" AND NEW."disabled_at_ms" IS NULL) OR (OLD."status" = 'disabled' AND NEW."status" = 'deleting' AND NEW."activated_at_ms" IS OLD."activated_at_ms" AND NEW."disabled_at_ms" IS OLD."disabled_at_ms")) THEN RAISE(ABORT, 'pack_release_lifecycle_transition_invalid') END;
END;

CREATE TRIGGER "trg:pack_releases:protected_delete" BEFORE DELETE ON "workflow_pack_releases" WHEN OLD."status" IN ('active', 'draining') BEGIN
  SELECT RAISE(ABORT, 'active_or_draining_pack_release_delete_forbidden');
END;

CREATE TRIGGER "trg:pack_active_releases:target_active_insert" AFTER INSERT ON "workflow_pack_active_releases" BEGIN
  SELECT CASE WHEN NEW."row_version" <> 1 OR NOT EXISTS (SELECT 1 FROM "workflow_pack_releases" AS release WHERE release."pack_id" = NEW."pack_id" AND release."id" = NEW."release_id" AND release."release_hash" = NEW."release_hash" AND release."status" = 'active') THEN RAISE(ABORT, 'pack_active_release_insert_invalid') END;
END;

CREATE TRIGGER "trg:pack_active_releases:cas_update" BEFORE UPDATE ON "workflow_pack_active_releases" BEGIN
  SELECT CASE WHEN NEW."pack_id" IS NOT OLD."pack_id" OR NEW."row_version" <> OLD."row_version" + 1 OR (NEW."release_id" IS OLD."release_id" AND NEW."release_hash" IS OLD."release_hash") OR NEW."activated_at_ms" < OLD."activated_at_ms" OR NOT EXISTS (SELECT 1 FROM "workflow_pack_releases" AS release WHERE release."pack_id" = NEW."pack_id" AND release."id" = NEW."release_id" AND release."release_hash" = NEW."release_hash" AND release."status" = 'active') THEN RAISE(ABORT, 'pack_active_release_cas_invalid') END;
END;

CREATE TRIGGER "trg:pack_active_releases:immutable_delete" BEFORE DELETE ON "workflow_pack_active_releases" BEGIN
  SELECT CASE WHEN NOT EXISTS (SELECT 1 FROM "workflow_pack_releases" AS release WHERE release."pack_id" = OLD."pack_id" AND release."id" = OLD."release_id" AND release."release_hash" = OLD."release_hash" AND release."status" = 'draining') THEN RAISE(ABORT, 'pack_active_release_delete_forbidden') END;
END;

CREATE TRIGGER "trg:retention_handles:immutable_published_identity" BEFORE UPDATE OF "id", "handle_kind", "pack_release_id", "graph_run_id", "backup_id", "external_actor_ref", "closure_manifest_id", "closure_hash", "created_at_ms" ON "workflow_registry_retention_handles" BEGIN
...
CREATE TRIGGER "trg:retention_handles:release_transition" BEFORE UPDATE OF "status", "released_at_ms", "row_version" ON "workflow_registry_retention_handles" BEGIN
  SELECT CASE WHEN NEW."row_version" <> OLD."row_version" + 1 OR OLD."status" <> 'held' OR NEW."status" <> 'released' OR (OLD."handle_kind" = 'published' AND EXISTS (SELECT 1 FROM "workflow_pack_releases" AS release WHERE release."id" = OLD."pack_release_id" AND release."status" IN ('active', 'draining'))) THEN RAISE(ABORT, 'retention_handle_release_transition_invalid') END;
END;

CREATE TRIGGER "trg:retention_handles:protected_delete" BEFORE DELETE ON "workflow_registry_retention_handles" WHEN OLD."handle_kind" = 'published' AND EXISTS (SELECT 1 FROM "workflow_pack_releases" AS release WHERE release."id" = OLD."pack_release_id" AND release."status" IN ('active', 'draining')) BEGIN
  SELECT RAISE(ABORT, 'active_or_draining_release_retention_delete_forbidden');
END;

CREATE TRIGGER "trg:activation_commands:immutable_identity" BEFORE UPDATE OF "command_type", "idempotency_domain", "idempotency_key", "request_value_id", "request_hash", "request_schema_resource_id", "request_schema_hash", "domain_request_hash", "created_at_ms" ON "workflow_pack_release_activation_commands" BEGIN
  SELECT RAISE(ABORT, 'activation_command_identity_is_immutable');
END;

CREATE TRIGGER "trg:activation_commands:verified_fact_transition" BEFORE UPDATE ON "workflow_pack_release_activation_commands" BEGIN
  SELECT CASE WHEN OLD."lifecycle" <> 'pending' OR NEW."row_version" <> OLD."row_version" + 1 OR (OLD."verified_target_pack_release_id" IS NOT NULL AND (NEW."verified_pack_id" IS NOT OLD."verified_pack_id" OR NEW."verified_target_pack_release_id" IS NOT OLD."verified_target_pack_release_id" OR NEW."verified_target_pack_release_ref" IS NOT OLD."verified_target_pack_release_ref" OR NEW."verified_target_pack_release_version" IS NOT OLD."verified_target_pack_release_version" OR NEW."verified_target_pack_release_hash" IS NOT OLD."verified_target_pack_release_hash")) OR (OLD."verified_previous_pack_release_id" IS NOT NULL AND (NEW."verified_previous_pack_release_id" IS NOT OLD."verified_previous_pack_release_id" OR NEW."verified_previous_pack_release_ref" IS NOT OLD."verified_previous_pack_release_ref" OR NEW."verified_previous_pack_release_version" IS NOT OLD."verified_previous_pack_release_version" OR NEW."verified_previous_pack_release_hash" IS NOT OLD."verified_previous_pack_release_hash")) OR (OLD."verified_target_retention_handle_id" IS NOT NULL AND (NEW."verified_target_retention_handle_id" IS NOT OLD."verified_target_retention_handle_id" OR NEW."verified_target_retention_handle_kind" IS NOT OLD."verified_target_retention_handle_kind" OR NEW."verified_target_retention_pack_release_id" IS NOT OLD."verified_target_retention_pack_release_id" OR NEW."verified_target_retention_closure_manifest_id" IS NOT OLD."verified_target_retention_closure_manifest_id" OR NEW."verified_target_retention_closure_hash" IS NOT OLD."verified_target_retention_closure_hash")) OR (OLD."verified_target_retention_observed_status" IS NOT NULL AND (NEW."verified_target_retention_observed_status" IS NOT OLD."verified_target_retention_observed_status" OR NEW."verified_target_retention_observed_row_version" IS NOT OLD."verified_target_retention_observed_row_version")) OR (OLD."verified_previous_retention_handle_id" IS NOT NULL AND (NEW."verified_previous_retention_handle_id" IS NOT OLD."verified_previous_retention_handle_id" OR NEW."verified_previous_retention_handle_kind" IS NOT OLD."verified_previous_retention_handle_kind" OR NEW."verified_previous_retention_pack_release_id" IS NOT OLD."verified_previous_retention_pack_release_id" OR NEW."verified_previous_retention_closure_manifest_id" IS NOT OLD."verified_previous_retention_closure_manifest_id" OR NEW."verified_previous_retention_closure_hash" IS NOT OLD."verified_previous_retention_closure_hash")) OR (OLD."verified_previous_retention_observed_status" IS NOT NULL AND (NEW."verified_previous_retention_observed_status" IS NOT OLD."verified_previous_retention_observed_status" OR NEW."verified_previous_retention_observed_row_version" IS NOT OLD."verified_previous_retention_observed_row_version")) OR (OLD."observed_pointer_state" IS NOT NULL AND (NEW."observed_pointer_state" IS NOT OLD."observed_pointer_state" OR NEW."observed_pointer_row_version" IS NOT OLD."observed_pointer_row_version" OR NEW."observed_pack_release_id" IS NOT OLD."observed_pack_release_id" OR NEW."observed_pack_release_ref" IS NOT OLD."observed_pack_release_ref" OR NEW."observed_pack_release_version" IS NOT OLD."observed_pack_release_version" OR NEW."observed_pack_release_hash" IS NOT OLD."observed_pack_release_hash")) THEN RAISE(ABORT, 'activation_command_verified_fact_transition_invalid') END;
END;

CREATE TRIGGER "trg:activation_commands:terminalization" BEFORE UPDATE OF "lifecycle" ON "workflow_pack_release_activation_commands" WHEN NEW."lifecycle" <> OLD."lifecycle" BEGIN
  SELECT CASE WHEN NEW."lifecycle" NOT IN ('applied', 'failed', 'conflict') OR NEW."terminal_disposition" IS NOT NEW."lifecycle" OR NOT EXISTS (SELECT 1 FROM "workflow_pack_release_activation_invocations" AS invocation WHERE invocation."id" = NEW."canonical_terminal_invocation_id" AND invocation."command_id" = NEW."command_id" AND invocation."invocation_no" = NEW."canonical_terminal_invocation_no" AND invocation."command_domain_request_hash" = NEW."domain_request_hash" AND invocation."submitted_request_hash" = NEW."canonical_terminal_submitted_request_hash" AND invocation."disposition" = NEW."terminal_disposition" AND invocation."invocation_hash" = NEW."canonical_terminal_invocation_hash" AND invocation."result_value_id" = NEW."canonical_terminal_result_value_id" AND invocation."result_hash" = NEW."canonical_terminal_result_hash" AND invocation."result_schema_resource_id" = NEW."canonical_terminal_result_schema_resource_id" AND invocation."result_schema_hash" = NEW."canonical_terminal_result_schema_hash") OR (NEW."lifecycle" = 'applied' AND (NEW."observed_pointer_state" IS NULL OR NEW."verified_target_pack_release_id" IS NULL OR NEW."verified_target_retention_observed_status" <> 'held' OR NOT EXISTS (SELECT 1 FROM "workflow_pack_releases" AS release WHERE release."pack_id" = NEW."verified_pack_id" AND release."id" = NEW."verified_target_pack_release_id" AND release."release_ref" = NEW."verified_target_pack_release_ref" AND release."release_version" = NEW."verified_target_pack_release_version" AND release."release_hash" = NEW."verified_target_pack_release_hash" AND release."status" = 'active') OR NOT EXISTS (SELECT 1 FROM "workflow_registry_retention_handles" AS handle WHERE handle."id" = NEW."verified_target_retention_handle_id" AND handle."handle_kind" = 'published' AND handle."pack_release_id" = NEW."verified_target_retention_pack_release_id" AND handle."closure_manifest_id" = NEW."verified_target_retention_closure_manifest_id" AND handle."closure_hash" = NEW."verified_target_retention_closure_hash" AND handle."status" = 'held' AND handle."row_version" = NEW."verified_target_retention_observed_row_version") OR NOT EXISTS (SELECT 1 FROM "workflow_pack_active_releases" AS pointer WHERE pointer."pack_id" = NEW."verified_pack_id" AND pointer."release_id" = NEW."verified_target_pack_release_id" AND pointer."release_hash" = NEW."verified_target_pack_release_hash" AND pointer."row_version" = NEW."applied_pointer_row_version") OR (NEW."observed_pointer_state" = 'absent' AND (NEW."applied_pointer_row_version" <> 1 OR NEW."verified_previous_pack_release_id" IS NOT NULL OR NEW."verified_previous_retention_handle_id" IS NOT NULL)) OR (NEW."observed_pointer_state" = 'present' AND (NEW."applied_pointer_row_version" <> NEW."observed_pointer_row_version" + 1 OR NEW."verified_previous_pack_release_id" IS NULL OR NEW."verified_previous_retention_observed_status" <> 'held' OR NEW."observed_pack_release_id" IS NOT NEW."verified_previous_pack_release_id" OR NEW."observed_pack_release_ref" IS NOT NEW."verified_previous_pack_release_ref" OR NEW."observed_pack_release_version" IS NOT NEW."verified_previous_pack_release_version" OR NEW."observed_pack_release_hash" IS NOT NEW."verified_previous_pack_release_hash" OR NOT EXISTS (SELECT 1 FROM "workflow_pack_releases" AS previous_release WHERE previous_release."pack_id" = NEW."verified_pack_id" AND previous_release."id" = NEW."verified_previous_pack_release_id" AND previous_release."release_ref" = NEW."verified_previous_pack_release_ref" AND previous_release."release_version" = NEW."verified_previous_pack_release_version" AND previous_release."release_hash" = NEW."verified_previous_pack_release_hash" AND previous_release."status" = 'draining') OR NOT EXISTS (SELECT 1 FROM "workflow_registry_retention_handles" AS previous_handle WHERE previous_handle."id" = NEW."verified_previous_retention_handle_id" AND previous_handle."handle_kind" = 'published' AND previous_handle."pack_release_id" = NEW."verified_previous_retention_pack_release_id" AND previous_handle."closure_manifest_id" = NEW."verified_previous_retention_closure_manifest_id" AND previous_handle."closure_hash" = NEW."verified_previous_retention_closure_hash" AND previous_handle."status" = 'held' AND previous_handle."row_version" = NEW."verified_previous_retention_observed_row_version"))))) OR (NEW."lifecycle" = 'conflict' AND (NEW."observed_pointer_state" IS NULL OR NEW."verified_target_pack_release_id" IS NULL OR NEW."verified_target_retention_observed_status" <> 'held')) THEN RAISE(ABORT, 'activation_command_terminalization_invalid') END;
END;

CREATE TRIGGER "trg:activation_commands:immutable_delete" BEFORE DELETE ON "workflow_pack_release_activation_commands" BEGIN
  SELECT RAISE(ABORT, 'activation_command_is_immutable');
END;

CREATE TRIGGER "trg:activation_invocations:hash_chain" AFTER INSERT ON "workflow_pack_release_activation_invocations" BEGIN
  SELECT CASE WHEN (NEW."invocation_no" = 1 AND NEW."previous_invocation_hash" IS NOT NULL) OR (NEW."invocation_no" > 1 AND (SELECT previous."invocation_hash" FROM "workflow_pack_release_activation_invocations" AS previous WHERE previous."command_id" = NEW."command_id" AND previous."invocation_no" = NEW."invocation_no" - 1) IS NOT NEW."previous_invocation_hash") THEN RAISE(ABORT, 'activation_invocation_hash_chain_invalid') END;
END;

CREATE TRIGGER "trg:activation_invocations:terminal_reference" AFTER INSERT ON "workflow_pack_release_activation_invocations" BEGIN
  SELECT CASE WHEN (NEW."disposition" = 'duplicate' AND NOT EXISTS (SELECT 1 FROM "workflow_pack_release_activation_commands" AS command WHERE command."command_id" = NEW."command_id" AND command."domain_request_hash" = NEW."submitted_request_hash" AND command."lifecycle" IN ('applied', 'failed', 'conflict') AND command."canonical_terminal_result_value_id" = NEW."referenced_terminal_result_value_id" AND command."canonical_terminal_result_hash" = NEW."referenced_terminal_result_hash" AND command."canonical_terminal_result_schema_resource_id" = NEW."referenced_terminal_result_schema_resource_id" AND command."canonical_terminal_result_schema_hash" = NEW."referenced_terminal_result_schema_hash")) OR (NEW."disposition" IN ('applied', 'failed') AND (NEW."referenced_terminal_result_value_id" IS NOT NEW."result_value_id" OR NEW."referenced_terminal_result_hash" IS NOT NEW."result_hash" OR NEW."referenced_terminal_result_schema_resource_id" IS NOT NEW."result_schema_resource_id" OR NEW."referenced_terminal_result_schema_hash" IS NOT NEW."result_schema_hash")) OR (NEW."disposition" = 'conflict' AND NEW."submitted_request_hash" = NEW."command_domain_request_hash" AND (NEW."referenced_terminal_result_value_id" IS NOT NEW."result_value_id" OR NEW."referenced_terminal_result_hash" IS NOT NEW."result_hash" OR NEW."referenced_terminal_result_schema_resource_id" IS NOT NEW."result_schema_resource_id" OR NEW."referenced_terminal_result_schema_hash" IS NOT NEW."result_schema_hash")) OR (NEW."disposition" = 'conflict' AND NEW."submitted_request_hash" <> NEW."command_domain_request_hash" AND NEW."referenced_terminal_result_value_id" IS NOT NULL AND NOT EXISTS (SELECT 1 FROM "workflow_pack_release_activation_commands" AS command WHERE command."command_id" = NEW."command_id" AND command."lifecycle" IN ('applied', 'failed', 'conflict') AND command."canonical_terminal_result_value_id" = NEW."referenced_terminal_result_value_id" AND command."canonical_terminal_result_hash" = NEW."referenced_terminal_result_hash" AND command."canonical_terminal_result_schema_resource_id" = NEW."referenced_terminal_result_schema_resource_id" AND command."canonical_terminal_result_schema_hash" = NEW."referenced_terminal_result_schema_hash")) THEN RAISE(ABORT, 'activation_invocation_terminal_reference_invalid') END;
END;

CREATE TRIGGER "trg:activation_invocations:closed_replay_disposition" AFTER INSERT ON "workflow_pack_release_activation_invocations" WHEN NEW."disposition" IN ('applied', 'failed') OR (NEW."disposition" = 'conflict' AND NEW."submitted_request_hash" = NEW."command_domain_request_hash") BEGIN
  SELECT CASE WHEN EXISTS (SELECT 1 FROM "workflow_pack_release_activation_commands" AS command WHERE command."command_id" = NEW."command_id" AND command."lifecycle" IN ('applied', 'failed', 'conflict')) THEN RAISE(ABORT, 'activation_invocation_closed_replay_must_be_duplicate') END;
END;

CREATE TRIGGER "trg:activation_invocations:immutable_update" BEFORE UPDATE ON "workflow_pack_release_activation_invocations" BEGIN
  SELECT RAISE(ABORT, 'activation_invocation_is_immutable');
END;

CREATE TRIGGER "trg:activation_invocations:immutable_delete" BEFORE DELETE ON "workflow_pack_release_activation_invocations" BEGIN
  SELECT RAISE(ABORT, 'activation_invocation_is_immutable');
END;

CREATE TRIGGER "trg:activation_events:command_binding" AFTER INSERT ON "workflow_pack_release_activation_events" BEGIN
  SELECT CASE WHEN (NEW."verified_target_pack_release_id" IS NOT NULL AND NOT EXISTS (SELECT 1 FROM "workflow_pack_release_activation_commands" AS command WHERE command."command_id" = NEW."command_id" AND command."verified_pack_id" = NEW."verified_pack_id" AND command."verified_target_pack_release_id" = NEW."verified_target_pack_release_id" AND command."verified_target_pack_release_ref" = NEW."verified_target_pack_release_ref" AND command."verified_target_pack_release_version" = NEW."verified_target_pack_release_version" AND command."verified_target_pack_release_hash" = NEW."verified_target_pack_release_hash")) OR (NEW."verified_previous_pack_release_id" IS NOT NULL AND NOT EXISTS (SELECT 1 FROM "workflow_pack_release_activation_commands" AS command WHERE command."command_id" = NEW."command_id" AND command."verified_pack_id" = NEW."verified_pack_id" AND command."verified_previous_pack_release_id" = NEW."verified_previous_pack_release_id" AND command."verified_previous_pack_release_ref" = NEW."verified_previous_pack_release_ref" AND command."verified_previous_pack_release_version" = NEW."verified_previous_pack_release_version" AND command."verified_previous_pack_release_hash" = NEW."verified_previous_pack_release_hash")) THEN RAISE(ABORT, 'activation_event_command_binding_invalid') END;
END;

CREATE TRIGGER "trg:activation_events:hash_chain" AFTER INSERT ON "workflow_pack_release_activation_events" BEGIN
  SELECT CASE WHEN (NEW."event_no" = 1 AND NEW."previous_event_hash" IS NOT NULL) OR (NEW."event_no" > 1 AND (SELECT previous."event_hash" FROM "workflow_pack_release_activation_events" AS previous WHERE previous."command_id" = NEW."command_id" AND previous."event_no" = NEW."event_no" - 1) IS NOT NEW."previous_event_hash") THEN RAISE(ABORT, 'activation_event_hash_chain_invalid') END;
END;

CREATE TRIGGER "trg:activation_events:immutable_update" BEFORE UPDATE ON "workflow_pack_release_activation_events" BEGIN
  SELECT RAISE(ABORT, 'activation_event_is_immutable');
END;

CREATE TRIGGER "trg:activation_events:immutable_delete" BEFORE DELETE ON "workflow_pack_release_activation_events" BEGIN
  SELECT RAISE(ABORT, 'activation_event_is_immutable');
END;
