...
const VALUE_REGISTRY_BACKUP_TABLES: readonly TableSeed[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      hash('core_build_hash'),
      hash('database_schema_hash'),
      at('created_at_ms'),
    ],
    primaryKey: ['id'],
    foreignKeys: [
...
const CREATION_WORKFLOW_CONTEXT_TABLES: readonly TableSeed[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      ...registryPair('compiler_toolchain'),
      ...externalPair('core_release', 'core_release_registry', 'core_release'),
      hash('core_build_hash'),
      integer('run_protocol_major', false, 'positive'),
      integer('executor_abi_major', false, 'positive'),
      integer('database_schema_version', false, 'positive'),
      hash('database_schema_hash'),
    ...
    foreignKeys: [
      ...
      registryFk('fk:graph_runs:compiler_toolchain', 'compiler_toolchain'),
      fk(
