...
export interface G39PackReleaseActivationStoreFixture {
  ...
  activation_request: G39PackReleaseActivationRequest;
...
export function withG39PreviousRelease(
  candidate: G39PackReleaseActivationRequest,
  previousRelease: G39PackReleaseClaim,
...
export function g39PackReleaseActivationStoreFixtureForTest(): G39PackReleaseActivationStoreFixture {
  ...
  const releaseId = workflowPackReleaseId(
  ...
  const activationRequest: G39PackReleaseActivationRequest = {
    format: 'icarus.workflow-pack-release-activation-request/1',
    command_type: 'activate_pack_release',
    idempotency_domain: 'fixture.pack-release-activation',
    ...
    pack_id: base.request.target_release.pack_id,
    target_release: {
