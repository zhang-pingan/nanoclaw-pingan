...
> = {
  ...
  provider_cancellation_requested: ['T7a'],
  provider_cancellation_retry_scheduled: ['OUTBOX'],
  provider_cancellation_acknowledged: ['OUTBOX'],
  provider_cancellation_not_required: ['OUTBOX'],
