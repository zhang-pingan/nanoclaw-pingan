...
semanticReview.$id =
  'https://icarus.local/schemas/g2-node-output-envelope-authority-successor-semantic-review-v2';
property(semanticReview, 'bundle_version').const = '2.0.0';
property(semanticReview, 'checklist_version').const =
  'g2-node-output-envelope-authority-successor-semantic-review/2';
...
inventory.$id =
  'https://icarus.local/schemas/g2-node-output-envelope-authority-successor-conformance-inventory-v2';
property(inventory, 'bundle_version').const = '2.0.0';

const bundle = clone(CURRENT_G2_GOLDEN_CONFORMANCE_BUNDLE_SCHEMA);
bundle.$id =
  'https://icarus.local/schemas/g2-node-output-envelope-authority-successor-conformance-bundle-v2';
property(bundle, 'bundle_version').const = '2.0.0';

export const G2_NODE_OUTPUT_ENVELOPE_SEMANTIC_REVIEW_SCHEMA = semanticReview;
export const G2_NODE_OUTPUT_ENVELOPE_SEALED_INVENTORY_SCHEMA = inventory;
export const G2_NODE_OUTPUT_ENVELOPE_CONFORMANCE_BUNDLE_SCHEMA = bundle;
