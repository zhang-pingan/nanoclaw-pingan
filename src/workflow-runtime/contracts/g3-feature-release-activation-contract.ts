...
const root = 'conformance/g3.9-feature-release-activation';
const paths = {
  requestSchema:
    'registry/workflow-feature-release-activation-request-schema@1.json',
  receiptSchema:
    'registry/workflow-feature-release-activation-receipt-schema@1.json',
  resultSchema:
    'registry/workflow-feature-release-activation-result-schema@1.json',
  positive: `${root}/positive-cases.json`,
  negative: `${root}/negative-cases.json`,
  fault: `${root}/fault-cases.json`,
  domains:
    'registry/workflow-feature-release-activation-domain-separators@1.json',
  manifest: 'contract-pack-g3.9-feature-release-activation.json',
} as const;

const domains = {
  requestSchema:
    'icarus:workflow-feature-release-activation-request-schema:1\n',
  receiptSchema:
    'icarus:workflow-feature-release-activation-receipt-schema:1\n',
  resultSchema: 'icarus:workflow-feature-release-activation-result-schema:1\n',
  positive: 'icarus:workflow-g3-feature-release-activation-positive-cases:1\n',
  negative: 'icarus:workflow-g3-feature-release-activation-negative-cases:1\n',
  fault: 'icarus:workflow-g3-feature-release-activation-fault-cases:1\n',
  catalog: 'icarus:workflow-feature-release-activation-domain-separators:1\n',
  manifest: 'icarus:workflow-contract-pack-g3-feature-release-activation:1\n',
} as const;
...
function buildArtifacts(): Array<[string, ContractArtifactEnvelope]> {
  const entries: Array<[string, ContractArtifactEnvelope]> = [
    [
      ...
      artifact(
        'icarus.workflow-feature-release-activation-request-schema/1',
        'icarus.workflow-feature-release-activation-request-schema',
    ...
    [
      ...
      artifact(
        'icarus.workflow-feature-release-activation-receipt-schema/1',
        'icarus.workflow-feature-release-activation-receipt-schema',
    ...
    [
      paths.resultSchema,
      artifact(
        'icarus.workflow-feature-release-activation-result-schema/1',
        'icarus.workflow-feature-release-activation-result-schema',
    ...
    [
      paths.positive,
      artifact(
        'icarus.workflow-g3-feature-release-activation-positive-cases/1',
        'icarus.workflow-g3-feature-release-activation-positive-cases',
        domains.positive,
        {
    ...
    [
      paths.negative,
      artifact(
        'icarus.workflow-g3-feature-release-activation-negative-cases/1',
        'icarus.workflow-g3-feature-release-activation-negative-cases',
        domains.negative,
    ...
    [
      paths.fault,
      artifact(
        'icarus.workflow-g3-feature-release-activation-fault-cases/1',
        'icarus.workflow-g3-feature-release-activation-fault-cases',
        domains.fault,
        {
  ...
  const catalogEntries = [
    ...
    {
      format: G39_FEATURE_RELEASE_ACTIVATION_FORMATS.request,
      domain_separator: G39_REQUEST_DOMAIN,
    },
    {
      format: 'icarus.workflow-feature-release-activation-domain-request/1',
      domain_separator: G39_DOMAIN_REQUEST_DOMAIN,
    },
    {
      format: G39_FEATURE_RELEASE_ACTIVATION_FORMATS.receipt,
      domain_separator: G39_RECEIPT_DOMAIN,
    },
    {
      format: G39_FEATURE_RELEASE_ACTIVATION_FORMATS.result,
      domain_separator: G39_RESULT_DOMAIN,
    },
    {
      format: 'icarus.workflow-feature-release-activation-invocation/1',
      domain_separator: G39_INVOCATION_DOMAIN,
    },
    {
      format: 'icarus.workflow-feature-release-activation-event/1',
      domain_separator: G39_EVENT_DOMAIN,
    },
    {
      format: 'icarus.workflow-feature-release-activation-command-id/1',
    ...
    {
      format: 'icarus.workflow-contract-pack-g3-feature-release-activation/1',
  ...
  entries.push([
    paths.domains,
    artifact(
      'icarus.workflow-feature-release-activation-domain-separators/1',
      'icarus.workflow-feature-release-activation-domain-separators',
      domains.catalog,
...
function buildManifest(
  ...
  return artifact(
    'icarus.workflow-contract-pack-g3-feature-release-activation/1',
    'icarus.workflow-contract-pack-g3-feature-release-activation',
    domains.manifest,
    {
      gate: 'G3',
      slice: 'G3.9',
...
function validateAll(
  ...
  validateG39FeatureReleaseActivationRequest(fixture.activation_request);
  if (
...
export function checkG39FeatureReleaseActivationContracts(): ContractArtifactEnvelope {
  const artifacts = buildArtifacts();
  const manifest = buildManifest(artifacts);
  validateAll(artifacts, manifest);
