...
const GENERATED_SCHEMA_PARAMETER_DOMAIN =
...
function generatedSchema(
  ...
  return {
    type: 'generated',
    generator,
    parameter_hash: hash(GENERATED_SCHEMA_PARAMETER_DOMAIN, parameter),
    schema_json: schemaJson,
    schema_hash: hash(GENERATED_SCHEMA_DOMAIN, schemaJson),
  };
}
