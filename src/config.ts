...
export const COLLABORATION_CODEX_BINARY =
  process.env.COLLABORATION_CODEX_BINARY ||
  envConfig.COLLABORATION_CODEX_BINARY ||
  WORKFLOW_CODEX_BINARY;
export const COLLABORATION_CODEX_CWD = path.resolve(
  process.env.COLLABORATION_CODEX_CWD ||
    envConfig.COLLABORATION_CODEX_CWD ||
    PROJECT_ROOT,
);
export const COLLABORATION_CODEX_MODEL =
  process.env.COLLABORATION_CODEX_MODEL ||
  envConfig.COLLABORATION_CODEX_MODEL ||
  '';
export const COLLABORATION_CODEX_DESKTOP_VISIBILITY_CONFIRMED =
  (process.env.COLLABORATION_CODEX_DESKTOP_VISIBILITY_CONFIRMED ||
    envConfig.COLLABORATION_CODEX_DESKTOP_VISIBILITY_CONFIRMED) === 'true';
